    ...
    implements Runnable
{
    ...
    public void run()
    {
        Object obj = new aoe(g.nS, a.c);
        Object obj1 = ((aoe) (obj)).e();
        Object obj2 = a.b;
        obj2 = ((apd) (obj1)).a("conversation_participants_view", new String[] {
            "gaia_id", "chat_id"
        ...
        i = ((aoe) (obj)).e().a("conversations", ((ContentValues) (obj1)), "conversation_id=?", new String[] {
            a.b
        });
        obj = a.b;
        obj1 = String.valueOf(((ContentValues) (obj1)).getAsString("inviter_chat_id"));
        ebw.a("Babel", (new StringBuilder(String.valueOf(obj).length() + 74 + String.valueOf(obj1).length())).append("modifying ").append(((String) (obj))).append(" pretend invite status with inviter_id ").append(((String) (obj1))).append(" updated ").append(i).append(" rows").toString());
        any.a(a.c);
        cej.a(g.nS, a.c);
    }
}
