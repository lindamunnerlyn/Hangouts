...
public class tw extends ViewGroup
{
    ...
    static void a(tw tw1)
    {
        tw1.View.setVisibility(0);
    }

    static void a(tw tw1, int i)
    {
        tw1.View.setVisibility(i);
    }
    ...
    public lr a(int i, long l)
    {
        ...
        if (i == 0)
        {
            ...
            lr lr1 = kb.p(this).a(1.0F);
            lr1.a(l);
            lr1.a(a.a(lr1, i));
            return lr1;
        } else
        {
            lr lr2 = kb.p(this).a(0.0F);
            lr2.a(l);
            lr2.a(a.a(lr2, i));
            return lr2;
        }
    ...
    protected void onConfigurationChanged(Configuration configuration)
    {
        ...
        configuration = getContext().obtainStyledAttributes(null, rq.a, g.g, 0);
        a(configuration.getLayoutDimension(rq.j, 0));
