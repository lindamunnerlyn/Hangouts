...
public abstract class eqt extends Binder
    implements eqs
{

    public static eqs a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof eqs))
        {
            return (eqs)iinterface;
        } else
        {
            return new equ(ibinder);
        }
    }
