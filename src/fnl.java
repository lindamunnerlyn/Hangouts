...
public abstract class fnl extends Binder
    implements fnk
{

    public static fnk a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fnk))
        {
            return (fnk)iinterface;
        } else
        {
            return new fnm(ibinder);
        }
    }
