...
public final class lrt extends kwm
{

    private static volatile lrt F[];
    public Float A;
    public Float B;
    public Float C;
    public Float D;
    ...
    public kws mergeFrom(kwj kwj1)
    {
        do
        {
            ...
            case 42: // '*'
                ...
                if (j1 != 0)
                {
                    System.arraycopy(e, 0, alrw, 0, j1);
                    l1 = j1;
                }
                for (; l1 < alrw.length - 1; l1++)
                {
                    alrw[l1] = new lrw();
                    kwj1.a(alrw[l1]);
                    kwj1.a();
            ...
            case 50: // '2'
                ...
                if (k1 != 0)
                {
                    System.arraycopy(f, 0, alrv, 0, k1);
                    i2 = k1;
                }
                for (; i2 < alrv.length - 1; i2++)
                {
                    alrv[i2] = new lrv();
                    kwj1.a(alrv[i2]);
                    kwj1.a();
