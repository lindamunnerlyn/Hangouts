...
public final class HttpMediaType
{
    ...
    private HttpMediaType fromString(String s)
    {
        ...
        l.a(s.matches(), "Type must be in the 'maintype/subtype; parameter=value' format");
        setType(s.group(1));
    ...
    public HttpMediaType setParameter(String s, String s1)
    {
        ...
        {
            l.a(TOKEN_REGEX.matcher(s).matches(), "Name contains reserved characters");
            cachedBuildResult = null;
    ...
    {
        l.a(TYPE_REGEX.matcher(s).matches(), "Subtype contains reserved characters");
        subType = s;
        cachedBuildResult = null;
        return this;
    }
    ...
    {
        l.a(TYPE_REGEX.matcher(s).matches(), "Type contains reserved characters");
        type = s;
        cachedBuildResult = null;
        return this;
    }
