...
final class qg
{
    ...
    private int L;
    private int M;
    private final android.view.View.OnClickListener N = new qh(this);
    final rp a;
    ListView b;
    Button c;
    Message d;
    ...
    public qg(Context context, rp rp1, Window window)
    {
        z = false;
        E = 0;
        j = -1;
        ...
        q = window;
        o = new qn(rp1);
        context = context.obtainStyledAttributes(null, rq.H, g.s, 0);
        K = context.getResourceId(rq.I, 0);
        L = context.getResourceId(rq.J, 0);
        k = context.getResourceId(rq.L, 0);
        l = context.getResourceId(rq.M, 0);
        m = context.getResourceId(rq.N, 0);
        n = context.getResourceId(rq.K, 0);
        context.recycle();
    }
