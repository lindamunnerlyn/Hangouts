...
public final class i
{
    ...
    public static Field a(Object obj, String s)
    {
        return b(obj, s);
    }
...
_L4:
        ...
        {
            (new StringBuilder("MultiDex is not guaranteed to work in SDK version ")).append(android.os.Build.VERSION.SDK_INT).append(": SDK version higher than 20 should be backed by runtime with built-in multidex capabilty but it's not the ").append("case here: java.vm.version=\"").append(System.getProperty("java.vm.version")).append("\"");
        }
        ...
        List list = j.a(context, ((ApplicationInfo) (obj)), file, false);
        if (!a(list))
        {
...
label0:
        {
            context = j.a(context, ((ApplicationInfo) (obj)), file, true);
            if (!a(((List) (context))))
            {
                break label0;
            }
...
label0:
        ...
        {
            g.a(classloader, list);
            return;
        }
    }

    public static void a(Object obj, String s, Object aobj[])
    {
        s = b(obj, s);
