...
_L2:
        ...
        if (129 != i)
        {
            throw new abw("Invalid Octet value!");
        }
        break; /* Loop/switch isn't completed */
_L9:
        k = i;
...
_L19:
    ...
    protected void a(acc acc1, int i)
    {
        if (acc1 == null)
        {
    ...
    protected void a(acc aacc[])
    {
        ...
        {
            arraylist.add(aacc[i]);
        }

        a.put(151, arraylist);
    }

    protected void b(acc acc1, int i)
    {
        if (acc1 == null)
        {
            throw new NullPointerException();
    ...
    protected acc c(int i)
    {
        return (acc)a.get(i);
    }

    protected acc[] d(int i)
    {
