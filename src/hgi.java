    ...
    implements android.content.DialogInterface.OnClickListener, android.content.DialogInterface.OnMultiChoiceClickListener
{
    ...
    public static hgi a(String s, CharSequence charsequence, String s1, String s2)
    {
        return (new hgi()).a(s, charsequence, s1, s2, 0, 0);
    }
    ...
    private hgj r()
    {
        ...
        if (getTargetFragment() instanceof hgj)
        {
            return (hgj)getTargetFragment();
        }
        if (getActivity() instanceof hgj)
        {
            return (hgj)getActivity();
        } else
        {
            return null;
        }
...
_L1:
        ...
        textview = (TextView)((View) (obj)).findViewById(l.uO);
...
_L7:
    ...
    protected hgi a(String s, CharSequence charsequence, String s1, String s2, int i, int j)
    {
