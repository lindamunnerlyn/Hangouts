...
public final class gym
{
    ...
    gym(short word0, short word1, int l, int i1, boolean flag)
    {
        c = word0;
        d = word1;
        f = l;
...
_L4:
    ...
    public boolean a(gyq agyq[])
    {
_L2:
        return false;
        if (h(agyq.length) || d != 5 && d != 10) goto _L2; else goto _L1
_L1:
        int l;
        int i1;
        if (d != 5)
...
_L3:
        gyq gyq1 = agyq[l];
        if (gyq1.a() >= 0L && gyq1.b() >= 0L && gyq1.a() <= 0xffffffffL && gyq1.b() <= 0xffffffffL) goto _L6; else goto _L5
_L5:
        l = 1;
_L12:
...
_L13:
        ...
        gyq1 = agyq[l];
        if (gyq1.a() >= 0xffffffff80000000L && gyq1.b() >= 0xffffffff80000000L && gyq1.a() <= 0x7fffffffL && gyq1.b() <= 0x7fffffffL) goto _L9; else goto _L8
_L8:
        l = 1;
_L14:
...
_L2:
        return false;
        if (obj == null || !(obj instanceof gym)) goto _L2; else goto _L1
_L1:
        obj = (gym)obj;
        if (((gym) (obj)).c != c || ((gym) (obj)).f != f || ((gym) (obj)).d != d)
        {
        ...
        if (((gym) (obj)).h instanceof long[])
        {
            return Arrays.equals((long[])h, (long[])((gym) (obj)).h);
        }
...
_L3:
        ...
        if (((gym) (obj)).h instanceof gyq[])
        {
            return Arrays.equals((gyq[])h, (gyq[])((gym) (obj)).h);
        }
        if (true) goto _L2; else goto _L4
_L4:
        if (h instanceof byte[])
        {
            if (((gym) (obj)).h instanceof byte[])
            {
                return Arrays.equals((byte[])h, (byte[])((gym) (obj)).h);
            }
        } else
        {
            return h.equals(((gym) (obj)).h);
        }
        if (true) goto _L2; else goto _L5
_L5:
        if (((gym) (obj)).h != null) goto _L2; else goto _L6
_L6:
        return true;
    }

    protected gyq f(int l)
    {
        if (d != 10 && d != 5)
        {
            String s = String.valueOf(b(d));
