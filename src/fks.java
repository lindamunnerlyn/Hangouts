...
public abstract class fks extends Binder
    implements fkr
{

    public static fkr a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fkr))
        {
            return (fkr)iinterface;
        } else
        {
            return new fkt(ibinder);
        }
    }
