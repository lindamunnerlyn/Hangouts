...
public final class hrv extends koj
{
...
_L25:
        ...
        if (l1 != 0)
        {
            System.arraycopy(k, 0, ahql, 0, l1);
            i5 = l1;
        }
        for (; i5 < ahql.length - 1; i5++)
        {
            ahql[i5] = new hql();
            kog1.a(ahql[i5]);
            kog1.a();
