...
public final class ckq extends BaseAdapter
{
    ...
    public ckq(DebugActivity debugactivity, Cursor cursor, int ai[])
    {
        c = debugactivity;
        a = cursor;
        b = ai;
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        textview = (TextView)view1.findViewById(h.dm);
        textview1 = (TextView)view1.findViewById(h.gT);
        a.moveToPosition(i);
        ai = b;
        k = ai.length;
        view = "";
...
_L1:
        ...
        if (DebugActivity.j(c) != null && com.google.android.apps.hangouts.phone.DebugActivity.RecordingService.b(DebugActivity.j(c)) != null)
        {
            i = a.getColumnIndex("conversation_id");
            if (i >= 0 && TextUtils.equals(a.getString(i), com.google.android.apps.hangouts.phone.DebugActivity.RecordingService.b(DebugActivity.j(c))))
            {
