...
public abstract class fkm extends Binder
    implements fkl
{

    public static fkl a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fkl))
        {
            return (fkl)iinterface;
        } else
        {
            return new fkn(ibinder);
        }
    }
