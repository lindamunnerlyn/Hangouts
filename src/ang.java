    ...
    implements Parcelable
{
    ...
    public static final android.os.Parcelable.Creator CREATOR = new anh();
    public String a;
    public String b;
    public String c;
    public String d;
    ...
    public ang(Cursor cursor)
    {
        ...
        if (DraftService.a())
        {
            ...
            ebw.b("Babel", (new StringBuilder(String.valueOf(cursor).length() + 28)).append("DraftInfo create by cursor: ").append(cursor).toString());
        }
    }

    public ang(String s, String s1, String s2, int i, String s3, String s4)
    {
        b = s;
        c = s1;
        s = s2;
        ...
        if (DraftService.a())
        {
            ...
            ebw.b("Babel", (new StringBuilder(String.valueOf(s).length() + 25)).append("DraftInfo create by arg: ").append(s).toString());
        }
    }
