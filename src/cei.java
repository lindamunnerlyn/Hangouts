...
final class cei extends cdk
{

    private static final Object h = new Object();
    private final boolean i;

    cei(Context context, int j, String s, String s1, int k, String s2, long l1, int i1)
    {
        super(context, j, k, dzx.a(s1), l1);
        boolean flag;
        if (i1 == 1)
        {
            flag = true;
    ...
    static void a(Context context, int j, List list)
    {
        ...
        if (list != null)
        {
            for (list = list.iterator(); list.hasNext(); treeset.add(((cei)list.next()).q.a())) { }
        }
        gmw1 = ((gms)hgx.a(context, gms)).b(j);
        Object obj1 = h;
        obj1;
        JVM INSTR monitorenter ;
        Object obj = gmw1.c("active_hangouts_list");
        list = ((List) (obj));
...
_L8:
        list = new String("OngoingHangoutNotifier.cancelOngoingNotification conversationId=");
          goto _L9
_L2:
        gmw1.b("active_hangouts_list", treeset).d();
...
_L12:
        ...
        ebw.b("Babel", (new StringBuilder(String.valueOf(context).length() + 44 + String.valueOf(list).length())).append("updateActiveHangouts: lastActive=").append(context).append("\nnewActive=").append(list).toString());
_L11:
        obj1;
        JVM INSTR monitorexit ;
        return;
...
_L14:
    ...
    protected int d()
    {
        if (i)
        {
            return com.google.android.apps.hangouts.R.drawable.cC;
        } else
        {
            return com.google.android.apps.hangouts.R.drawable.cy;
        }
    }
