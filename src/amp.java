...
public class amp extends SQLiteOpenHelper
{
    ...
    amp(Context context)
    {
        ...
        ebw.c("Babel", "ApnDatabase constructor");
    }
    ...
    {
        return ((amp)hgx.a(context, amp)).e;
    }
...
_L1:
        ...
        if (d)
        {
            ebw.a("Babel", "ApnDatabase.loadUserDataFromOldTable: no old user data", sqlitedatabase);
        }
        sqlitedatabase = null;
...
_L11:
        ...
        list = ((List) (obj));
        ebw.e("Babel", (new StringBuilder(String.valueOf(s).length() + 50)).append("ApnDatabase.saveUserDataFromOldTable: query error ").append(s).toString(), sqliteexception);
        if (obj != null)
        {
            ((Cursor) (obj)).close();
        }
...
_L9:
    ...
    private static void f(SQLiteDatabase sqlitedatabase)
    {
        ...
        if (d)
        {
            ebw.b("Babel", "ApnDatabase loadApnTable");
        }
        xmlresourceparser = g.nS.getResources().getXml(g.iq);
        dqm dqm1 = dqm.a(xmlresourceparser);
        dqm1.a(new amq(sqlitedatabase));
        dqm1.a();
    ...
    public void onCreate(SQLiteDatabase sqlitedatabase)
    {
        ...
        {
            obj = apa.a(g.nS, ((ani) (obj)).h()).b();
            a(sqlitedatabase, a(((apd) (obj)).e()));
            ((apd) (obj)).a("DROP TABLE IF EXISTS apn;");
            return;
        }
    }
