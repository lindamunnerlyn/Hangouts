...
public abstract class epr extends Binder
    implements epq
{

    public static epq a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof epq))
        {
            return (epq)iinterface;
        } else
        {
            return new eps(ibinder);
        }
    }
