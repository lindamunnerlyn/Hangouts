...
public final class kxd
{
    ...
    public static kxb a(Resources resources, int i)
    {
        return a(resources.openRawResource(i), Integer.valueOf(0), Integer.valueOf(0), a);
    }

    private static kxb a(InputStream inputstream, Integer integer, Integer integer1, float f)
    {
        ...
        try
        {
            ...
            kxk kxk1 = new kxk(picture);
            kxk1.a(integer, integer1);
            kxk1.a(false);
            kxk1.a(f);
            inputstream = new kxe(inputstream);
            integer = new kxg();
            xmlreader.setContentHandler(integer);
            inputstream.a();
            xmlreader.parse(new InputSource(inputstream.a()));
            kxk1.a = ((kxg) (integer)).a;
            xmlreader.setContentHandler(kxk1);
            xmlreader.parse(new InputSource(inputstream.a()));
            long l1 = System.currentTimeMillis();
            (new StringBuilder(48)).append("Parsing complete in ").append(l1 - l).append(" millis.");
            inputstream = new kxb(picture, kxk1.o);
            if (!Float.isInfinite(kxk1.p.top))
            {
                inputstream.a(kxk1.p);
            }
        }
...
_L1:
        kxi kxi1 = d(s.substring(7));
        if (kxi1.a.size() == 6)
        {
            Matrix matrix1 = new Matrix();
            matrix1.setValues(new float[] {
                ((Float)kxi1.a.get(0)).floatValue(), ((Float)kxi1.a.get(2)).floatValue(), ((Float)kxi1.a.get(4)).floatValue(), ((Float)kxi1.a.get(1)).floatValue(), ((Float)kxi1.a.get(3)).floatValue(), ((Float)kxi1.a.get(5)).floatValue(), 0.0F, 0.0F, 1.0F
            });
...
_L2:
        ...
        {
            kxi2 = d(s.substring(10));
            if (kxi2.a.size() > 0)
            {
                f1 = ((Float)kxi2.a.get(0)).floatValue();
                float f;
                float f2;
                if (kxi2.a.size() > 1)
                {
                    f = ((Float)kxi2.a.get(1)).floatValue();
                } else
                {
                    f = 0.0F;
                }
        ...
        {
            kxi2 = d(s.substring(6));
            if (kxi2.a.size() > 0)
            {
                f2 = ((Float)kxi2.a.get(0)).floatValue();
                if (kxi2.a.size() > 1)
                {
                    f = ((Float)kxi2.a.get(1)).floatValue();
                } else
        ...
        if (s.startsWith("skewX("))
        {
            ...
            if (kxi2.a.size() > 0)
            {
                matrix.preSkew((float)Math.tan(((Float)kxi2.a.get(0)).floatValue()), 0.0F);
            }
        } else
        if (s.startsWith("skewY("))
        {
            ...
            if (kxi2.a.size() > 0)
            {
                matrix.preSkew(0.0F, (float)Math.tan(((Float)kxi2.a.get(0)).floatValue()));
            }
        } else
        if (s.startsWith("rotate("))
        {
            kxi2 = d(s.substring(7));
            if (kxi2.a.size() > 0)
            {
                f3 = ((Float)kxi2.a.get(0)).floatValue();
                if (kxi2.a.size() > 2)
                {
                    f2 = ((Float)kxi2.a.get(1)).floatValue();
                    f = ((Float)kxi2.a.get(2)).floatValue();
                } else
                {
                    f = 0.0F;
                    f2 = 0.0F;
    ...
    static kxi b(String s, Attributes attributes)
    {
        int j = attributes.getLength();
        for (int i = 0; i < j; i++)
        {
    ...
    static Path c(String s)
    {
        ...
        f4 = 0.0F;
_L16:
        if (kxa1.a >= k) goto _L2; else goto _L1
_L1:
        int i;
        char c2 = s.charAt(kxa1.a);
        float f6;
        float f16;
