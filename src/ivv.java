...
public final class ivv extends kwm
{

    public static final kwn a = kwn.a(ivv, 0x102d7e72L);
    private static final ivv p[] = new ivv[0];
    public String b;
    public ivy c[];
    public String d[];
    public String e;
...
_L7:
        ...
        if (k1 != 0)
        {
            System.arraycopy(c, 0, aivy, 0, k1);
            j2 = k1;
        }
        for (; j2 < aivy.length - 1; j2++)
        {
            aivy[j2] = new ivy();
            kwj1.a(aivy[j2]);
            kwj1.a();
