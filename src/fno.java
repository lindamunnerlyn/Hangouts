...
public abstract class fno extends Binder
    implements fnn
{

    public static fnn a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fnn))
        {
            return (fnn)iinterface;
        } else
        {
            return new fnp(ibinder);
        }
    }
