...
public final class ejn
{
    ...
    {
        byte byte0 = 9;
        if (!emx.a) goto _L2; else goto _L1
_L1:
        int i = 0;
_L12:
        return i;
_L2:
        ...
        try
        {
            context.getResources().getString(g.rg);
        }
...
_L8:
        ...
        ejp.a();
        if (!eos.b(((PackageInfo) (obj)).versionCode) && !eos.a(context)) goto _L10; else goto _L9
_L9:
        i = byte0;
        if (ejp.a(((PackageInfo) (obj)), eug.a) == null) goto _L12; else goto _L11
_L11:
        i = eos.a(a);
        if (eos.a(((PackageInfo) (obj)).versionCode) < i)
        {
...
_L10:
        obj1 = ejp.a(packagemanager.getPackageInfo("com.android.vending", 64), eug.a);
        i = byte0;
        if (obj1 == null) goto _L12; else goto _L13
_L13:
        obj1 = ejp.a(((PackageInfo) (obj)), new eox[] {
            obj1
        });
        if (obj1 == null)
        {
...
_L14:
        if (ejp.a(((PackageInfo) (obj)), eug.a) == null)
        {
            return 9;
        }
          goto _L11
    ...
    public static Intent a(int i)
    {
        ...
        case 1: // '\001'
        case 2: // '\002'
            return enr.b("com.google.android.gms");

        case 42: // '*'
            return enr.a();

        case 3: // '\003'
            return enr.a("com.google.android.gms");
        }
    }
...
label0:
    ...
    public static boolean a(int i, Activity activity, ad ad, int j, android.content.DialogInterface.OnCancelListener oncancellistener)
    {
        ...
        {
            activity = ((ai)activity).t_();
            ejq.a(ad, oncancellistener).a(activity, "GooglePlayServicesErrorDialog");
        } else
        if (g.k(11))
        {
            activity = activity.getFragmentManager();
            ejj.a(ad, oncancellistener).show(activity, "GooglePlayServicesErrorDialog");
        } else
        {
    ...
    public static boolean a(Context context, int i)
    {
        if (a(context, i, "com.google.android.gms"))
        {
            ...
            if (ejp.a().a(context, "com.google.android.gms"))
            {
                return true;
            }
        }
...
_L21:
        ...
        if (ad == null)
        {
            ad = new emy(activity, oncancellistener, j);
        } else
        {
            ad = new emy(ad, oncancellistener, j);
        }
...
_L5:
        activity = ad.getString(g.qY);
        continue; /* Loop/switch isn't completed */
_L7:
        activity = ad.getString(g.qU);
        continue; /* Loop/switch isn't completed */
_L17:
        activity = ad.getString(g.rn);
        continue; /* Loop/switch isn't completed */
_L6:
        activity = ad.getString(g.rl);
        continue; /* Loop/switch isn't completed */
_L18:
        activity = ad.getString(g.qQ);
        continue; /* Loop/switch isn't completed */
_L12:
        Log.e("GoogleApiAvailability", "Google Play services is invalid. Cannot recover.");
        activity = ad.getString(g.ri);
        continue; /* Loop/switch isn't completed */
_L10:
...
_L20:
    ...
    public static void b(Context context)
    {
        ...
        if (i != 0)
        {
            ...
            {
                throw new ejm(i, "Google Play Services not available", context);
            }
        } else
        {
            return;
...
_L1:
        ...
        ejp.a();
        if (ejp.a(packagemanager, new eox[] {
            eow.b[1]
...
_L27:
        ...
        if (obj == null)
        {
            obj1 = ((Resources) (obj2)).getString(g.rd);
        }
        obj = context.getResources();
        i;
...
_L28:
        ...
        {
            h.a(g.k(16));
            obj = (new android.app.Notification.Builder(context)).setSmallIcon(g.qN).setPriority(2).setAutoCancel(true).setStyle((new android.app.Notification.BigTextStyle()).bigText((new StringBuilder()).append(((String) (obj1))).append(" ").append(((String) (obj))).toString())).addAction(g.qM, ((Resources) (obj2)).getString(g.ro), pendingintent).build();
        } else
        {
            obj2 = ((Resources) (obj2)).getString(g.rd);
            if (g.k(11))
            {
...
_L5:
        obj = null;
          goto _L27
_L2:
        obj = ((Resources) (obj)).getString(g.qY);
          goto _L27
_L4:
        obj = ((Resources) (obj)).getString(g.qU);
          goto _L27
_L14:
        obj = ((Resources) (obj)).getString(g.rn);
          goto _L27
_L3:
        obj = ((Resources) (obj)).getString(g.rl);
          goto _L27
_L15:
        obj = ((Resources) (obj)).getString(g.qQ);
          goto _L27
_L9:
        Log.e("GoogleApiAvailability", "Google Play services is invalid. Cannot recover.");
...
_L13:
        Log.e("GoogleApiAvailability", "The specified account could not be signed in.");
        obj = ((Resources) (obj)).getString(g.rf);
          goto _L27
_L17:
        if (g.a(((Resources) (obj))))
        {
            obj = ((Resources) (obj)).getString(g.qX, new Object[] {
                obj3
            });
        } else
        {
            obj = ((Resources) (obj)).getString(g.qW, new Object[] {
                obj3
            });
        }
          goto _L28
_L25:
        obj = ((Resources) (obj)).getString(g.rm, new Object[] {
          ...
          goto _L28
_L18:
        obj = ((Resources) (obj)).getString(g.rk, new Object[] {
            obj3
        });
          goto _L28
_L26:
        obj = ((Resources) (obj)).getString(g.qO, new Object[] {
            obj3
        });
          goto _L28
_L19:
        obj = ((Resources) (obj)).getString(g.qT, new Object[] {
          ...
          goto _L28
_L22:
        obj = ((Resources) (obj)).getString(g.rh, new Object[] {
            obj3
        });
          goto _L28
_L21:
        obj = ((Resources) (obj)).getString(g.rb);
          goto _L28
_L20:
        obj = ((Resources) (obj)).getString(g.qZ);
          goto _L28
_L23:
        obj = ((Resources) (obj)).getString(g.qR, new Object[] {
            obj3
        });
          goto _L28
_L24:
