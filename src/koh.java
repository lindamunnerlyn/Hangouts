...
public final class koh
{
    ...
    private koh(ByteBuffer bytebuffer)
    {
        a = bytebuffer;
        a.order(ByteOrder.LITTLE_ENDIAN);
    }

    private koh(byte abyte0[], int l, int i1)
    {
...
_L4:
    ...
    public static koh a(byte abyte0[], int l, int i1)
    {
        return new koh(abyte0, l, i1);
    }
...
_L4:
    ...
    public static int c(int l, kop kop1)
    {
        return (f(l) << 1) + kop1.getSerializedSize();
    }
    ...
    public static int d(int l, kop kop1)
    {
        l = f(l);
        int i1 = kop1.getSerializedSize();
        return l + (i1 + h(i1));
    }
    ...
    private void e(long l)
    {
        if (a.remaining() < 8)
        {
            throw new koi(a.position(), a.limit());
        } else
        {
            a.putLong(l);
            return;
    ...
    public void a(int l, String s)
    {
        ...
        {
            koi1 = new koi(a.position(), a.limit());
            koi1.initCause(s);
            throw koi1;
        }
        g(a(((CharSequence) (s))));
