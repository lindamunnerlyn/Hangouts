    ...
    implements id
{
    ...
    private int c;
    private int d;
    private final Handler h = new if(this);
    ...
    public ie(Context context, android.view.GestureDetector.OnGestureListener ongesturelistener, Handler handler)
    {
        i = ongesturelistener;
    ...
    static MotionEvent a(ie ie1)
    {
        return ie1.p;
    }

    static android.view.GestureDetector.OnGestureListener b(ie ie1)
    {
        return ie1.i;
    }

    static void c(ie ie1)
    {
        ie1.h.removeMessages(3);
        ie1.l = false;
        ie1.m = true;
        ie1.i.onLongPress(ie1.p);
    }

    static android.view.GestureDetector.OnDoubleTapListener d(ie ie1)
    {
        return ie1.j;
    }

    static boolean e(ie ie1)
    {
        return ie1.k;
    }

    static boolean f(ie ie1)
    {
        ie1.l = true;
        return true;
    }
    ...
    public boolean a(MotionEvent motionevent)
    {
        ...
        for (f2 = 0.0F; i3 < k3; f2 = f3)
        {
            ...
            if (i2 != i3)
            {
                f3 = f2 + jg.c(motionevent, i3);
                f6 = f1 + jg.d(motionevent, i3);
            }
            i3++;
            f1 = f6;
        }
...
_L7:
        ...
        int j2 = jg.b(motionevent);
        int j1 = jg.b(motionevent, j2);
        f1 = jx.a(x, j1);
        f2 = jx.b(x, j1);
        j1 = 0;
        while (j1 < k3) 
        {
            if (j1 != j2)
            {
                int j3 = jg.b(motionevent, j1);
                float f4 = jx.a(x, j3);
                if (jx.b(x, j3) * f2 + f4 * f1 < 0.0F)
                {
                    x.clear();
                    return false;
                }
...
_L3:
        ...
        {
            velocitytracker = x;
            l1 = jg.b(motionevent, 0);
            velocitytracker.computeCurrentVelocity(1000, d);
            f1 = jx.b(velocitytracker, l1);
            f2 = jx.a(velocitytracker, l1);
