...
public final class bso extends bpe
{
    ...
    public bso(Context context, gmt gmt, int j, int k, int l, int i1, int j1, 
            String s, String s1, boolean flag, boolean flag1, android.view.View.OnClickListener onclicklistener)
    {
        super(context, gmt, l, i1, j, flag, flag1, s, onclicklistener);
        g = k;
        h = j1;
        i = s1;
    }
    ...
    public View a(LayoutInflater layoutinflater, int j, ViewGroup viewgroup)
    {
        ...
        ((ImageButton)layoutinflater.findViewById(a)).setOnTouchListener(new bsp(this));
        a(e);
