...
public final class grk
{
    ...
    public grk(int k, Exception exception, String s)
    {
        g = grl.c;
        c = k;
        d = exception;
    ...
    grk(int k, Exception exception, String s, byte abyte0[], long l)
    {
        g = grl.c;
        c = k;
        d = exception;
    ...
    public static boolean a(grk grk1)
    {
        return grk1 != null && grk1.f();
    }
