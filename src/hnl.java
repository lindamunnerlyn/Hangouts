    ...
    implements Serializable
{
    ...
    private hnl(boolean flag, long l, Integer integer)
    {
        d = flag;
        c = l;
        int i;
...
_L3:
        int i2;
        i2 = Integer.parseInt(((Matcher) (obj)).group(8).substring(1));
        i1 = l1;
        k = k1;
        i = j1;
_L5:
...
_L4:
    ...
    public boolean equals(Object obj)
    {
        if (obj != this)
        {
            ...
            obj = (hnl)obj;
            if (d != ((hnl) (obj)).d || c != ((hnl) (obj)).c || e != ((hnl) (obj)).e)
            {
                return false;
            }
        }
