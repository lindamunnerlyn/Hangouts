    ...
    implements ListAdapter
{
    ...
    cmz(DebugBitmapsActivity debugbitmapsactivity)
    {
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        if (view == null)
        {
            view1 = a.getLayoutInflater().inflate(g.fE, viewgroup, false);
        }
...
_L1:
        ...
        textview = (TextView)view1.findViewById(h.fZ);
        textview1 = (TextView)view1.findViewById(h.ga);
        textview2 = (TextView)view1.findViewById(h.gb);
