...
public abstract class fxg extends Binder
    implements fxf
{
    ...
    public static fxf a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fxf))
        {
            return (fxf)iinterface;
        } else
        {
            return new fxh(ibinder);
        }
    }
