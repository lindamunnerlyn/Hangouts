...
public final class fdi
{
    ...
    private fdi(ByteBuffer bytebuffer)
    {
        a = bytebuffer;
    }

    private fdi(byte abyte0[], int i, int j)
    {
...
_L4:
    ...
    public static fdi a(byte abyte0[], int i, int j)
    {
        return new fdi(abyte0, 0, j);
    }
    ...
    public static int b(int i, fdo fdo1)
    {
        i = c(i);
        int j = fdo1.g();
        return i + (j + e(j));
...
_L4:
    ...
    private void g(int i)
    {
        ...
        if (!a.hasRemaining())
        {
            throw new cby(a.position(), a.limit());
        } else
        {
            a.put(byte0);
            return;
