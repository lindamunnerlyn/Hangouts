...
public abstract class oa extends BaseAdapter
    implements Filterable, oe
{
    ...
    public oa(Context context, Cursor cursor)
    {
        a(context, null, 1);
    }

    public oa(Context context, Cursor cursor, byte byte0)
    {
        a(context, cursor, 0);
    }
