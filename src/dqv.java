...
_L5:
    ...
    public static void a(String s1, String s2, String s3)
    {
        ...
        {
            ebw.g("Babel_SMS", (new StringBuilder(String.valueOf(s1).length() + 28 + String.valueOf(s2).length() + String.valueOf(s3).length())).append("MmsConfig.update: invalid ").append(s1).append(",").append(s2).append(",").append(s3).toString());
            return;
        }
        if ("bool".equals(s3))
        {
    ...
    public static void b(Context context)
    {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 19)
        {
            ...
            obj = f;
            String s1 = g;
            ebw.e("Babel_SMS", (new StringBuilder(String.valueOf(obj).length() + 66 + String.valueOf(s1).length())).append("MmsConfig.loadDeviceMmsSettings from API: mUserAgent=").append(((String) (obj))).append(", mUaProfUrl=").append(s1).toString());
        }
...
_L3:
        if (TextUtils.isEmpty(f))
        {
            ...
            Object obj2 = String.valueOf(String.valueOf(((ecs)hgx.a(context, ecs)).c()));
        ...
        context = f;
        obj1 = g;
        ebw.e("Babel_SMS", (new StringBuilder(String.valueOf(context).length() + 51 + String.valueOf(obj1).length())).append("MmsConfig.loadMmsSettings: mUserAgent=").append(context).append(", mUaProfUrl=").append(((String) (obj1))).toString());
        if (b)
        {
            context = String.valueOf(d);
            ebw.b("Babel_SMS", (new StringBuilder(String.valueOf(context).length() + 25)).append("MmsConfig: all values -- ").append(context).toString());
        }
        return;
_L2:
        ebw.e("Babel_SMS", "MmsConfig.loadFromResources");
        obj1 = context.getResources().getXml(g.ir);
        obj2 = dqm.a(((org.xmlpull.v1.XmlPullParser) (obj1)));
        ((dqm) (obj2)).a(new dqx());
        ((dqm) (obj2)).a();
    ...
    {
        Object obj;
        ebw.e("Babel_SMS", "MmsConfig.loadFromDatabase");
        ...
        obj = context.query("mmsconfig", amp.c, "numeric=?", new String[] {
            obj
        }, null, null, null);
...
_L9:
        ...
        context = ((Context) (obj));
        ebw.e("Babel_SMS", (new StringBuilder(String.valueOf(obj1).length() + 30)).append("MmsConfig: no mmsconfig table ").append(((String) (obj1))).toString());
        if (obj != null)
        {
            ((Cursor) (obj)).close();
        }
...
_L8:
    ...
    private static String z()
    {
        byte abyte0[];
        String s1;
        s1 = adq.a("persist.radio.cdma.nai");
        abyte0 = s1;
