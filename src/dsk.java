...
public final class dsk
{
    ...
    private dsk(long l1, String s, String s1, int i1, int j1, String s2, 
    ...
    public dsk(String s, String s1, int i1)
    {
        this(-1L, s, s1, i1, -1, null, null, null, null, null, null, null, null);
    }

    public static dsk a(Cursor cursor, boolean flag)
    {
        if (cursor == null || !dsj.b(cursor.getString(0), "mms")) goto _L2; else goto _L1
_L1:
        String s;
        String s1;
        int i1;
...
_L6:
        ...
        return new dsk(l1, s11, s, i1, j1, s2, s5, s6, s7, s1, s10, s9, s8);
        Exception exception;
        exception;
        String s3 = String.valueOf(exception);
        ebw.g("Babel_SMS", (new StringBuilder(String.valueOf(s3).length() + 55)).append("TransactionSettings.Apn.fromCursor: invalid proxy port ").append(s3).toString());
        s3 = s;
        s = s1;
        i1 = -1;
        s1 = s3;
        ...
        ebw.g("Babel_SMS", (new StringBuilder(String.valueOf(s4).length() + 58)).append("TransactionSettings.Apn.fromCursor: invalid current value ").append(s4).toString());
        j1 = 0;
          goto _L6
_L2:
        return null;
_L4:
    ...
    {
        if (ebw.a("Babel_SMS", 2))
        {
            long l1 = a;
            ebw.b("Babel_SMS", (new StringBuilder(59)).append("TransactionSettings: set ").append(l1).append(" to be current").toString());
        }
