...
public final class fen extends ena
{

    private Context e;

    public fen(Context context, Looper looper, eka eka, ekc ekc, emo emo)
    {
        super(context, looper, 29, emo, eka, ekc);
        e = context;
    }
    ...
    {
        ((feo)n()).a(a(feedbackoptions, e.getCacheDir()));
    }
