    ...
    implements Parcelable, Serializable
{
    ...
    {
        return context.getResources().getString(h.iz);
    }

    static String a(cfz cfz1, String s1)
    {
        cfz1.F = s1;
        return s1;
    }
    ...
    static byte[] a(cfz cfz1)
    {
        return cfz1.G;
    }

    static byte[] a(cfz cfz1, byte abyte0[])
    {
        cfz1.G = abyte0;
        return abyte0;
    }
    ...
    public String e()
    {
        ...
        g.d(flag, "Illegal states for CallerIdPhoneNumber, only null or non-zero-length values are permitted");
        return F;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        {
            obj = (cfz)obj;
            if (b != null && ((cfz) (obj)).b != null)
            {
                return b.a(((cfz) (obj)).b);
            }
        }
        return false;
    }
