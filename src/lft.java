    ...
    implements lge, lgi
{
    ...
    protected lft(lcz lcz1, int i, int j)
    {
        c = lcz1;
        int k = j;
        if (j > 18)
    ...
    public int a(lgf lgf1, String s, int i)
    {
        ...
        {
            lgf1.a(new lff(lcz.a(), lfd.a, lcy1.d()), (int)l);
            return j + i;
        }
    }
...
_L2:
        ...
        j = b;
          goto _L10
_L48:
        if ((l2 * l) / l == l2) goto _L12; else goto _L11
_L11:
        j--;
          goto _L10
_L12:
...
_L21:
        ...
        i--;
          goto _L21
        if (i >= lcw.length()) goto _L23; else goto _L22
_L22:
...
_L26:
        ...
        stringbuffer.append(lcw.charAt(j));
        j++;
