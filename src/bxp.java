...
public final class bxp extends eez
{
    ...
    private bxp(Context context, byte byte0)
    {
        super(context, null);
    }
...
_L2:
        ...
        ebw.e("Babel", s, malformedurlexception);
        return null;
...
_L4:
    ...
    {
        d(s);
        setOnClickListener(new bxq(this, s));
        ani ani = dbf.e(i);
        String s1 = d(s);
        if (TextUtils.isEmpty(s1))
        {
            ebw.g("Babel", "Found no videoId when trying to get the thumbnail for the yotube video");
        } else
        {
