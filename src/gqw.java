...
final class gqw
{
    ...
    public gqw(Context context, String s)
    {
    ...
    private void a(gqx gqx1)
    {
        b.add(gqx1);
        e = e + a(gqx1.c);
    }

    private void a(Iterator iterator, gqx gqx1)
    {
        iterator.remove();
        e = e - a(gqx1.c);
    }
    ...
    private void b()
    {
        ...
        do
        {
            ...
            gqx gqx1 = (gqx)iterator.next();
            if (gqx1.c.h())
            {
                if (Log.isLoggable("BackgroundTask", 4))
                {
                    String s = String.valueOf(gqx1.c);
                    String s1 = gqx1.b;
    ...
    {
        gqx gqx1;
        for (Iterator iterator = b.iterator(); e > 0x7d000 && iterator.hasNext(); a(iterator, gqx1))
        {
            gqx1 = (gqx)iterator.next();
            if (Log.isLoggable("BackgroundTask", 4))
            {
                String s = String.valueOf(gqx1.c);
                String s1 = gqx1.b;
...
_L2:
        ...
        obj = datainputstream;
        a((gqx)g.a(abyte0, gqx.getClassLoader()));
        i++;
...
_L2:
        ...
        obj = obj1;
        byte abyte0[] = g.a((gqx)iterator1.next());
        obj = obj1;
...
label0:
        {
            synchronized (b)
            {
                ...
                do
                {
                    ...
                    gqx1 = (gqx)iterator.next();
                } while (gqx1.a != i || !TextUtils.equals(gqx1.b, s));
                a(iterator, gqx1);
                s = gqx1.c;
            }
            return s;
    ...
    public void a(int i, String s, grk grk1)
    {
        if (a(grk1) > 0x1f400)
        {
            if (Log.isLoggable("BackgroundTask", 5))
            {
                grk1 = String.valueOf(grk1);
                (new StringBuilder(String.valueOf(grk1).length() + 34 + String.valueOf(s).length())).append("Result too large to store: ").append(grk1).append(", tag: ").append(s);
            }
            return;
        }
        synchronized (b)
