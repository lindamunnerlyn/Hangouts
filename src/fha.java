...
public abstract class fha extends Binder
    implements fgz
{

    public static fgz a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fgz))
        {
            return (fgz)iinterface;
        } else
        {
            return new fhb(ibinder);
        }
    }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 2: // '\002'
            parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
            ezy ezy1 = ezz.a(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
            ...
            a(ezy1, ((StreetViewPanoramaOptions) (obj)), parcel);
            parcel1.writeNoException();
            return true;
        ...
        case 4: // '\004'
            parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
            ezy ezy2 = ezz.a(parcel.readStrongBinder());
            ezy ezy3 = ezz.a(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
                parcel = (Bundle)Bundle.CREATOR.createFromParcel(parcel);
            } else
        ...
        case 12: // '\f'
            parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
            a(fjr.a(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        }
    }
