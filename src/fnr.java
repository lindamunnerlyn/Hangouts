...
public abstract class fnr extends Binder
    implements fnq
{

    public static fnq a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fnq))
        {
            return (fnq)iinterface;
        } else
        {
            return new fns(ibinder);
        }
    }
