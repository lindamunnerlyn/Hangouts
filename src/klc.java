...
public final class klc extends koj
{

    private static volatile klc g[];
    public Integer a;
    public Float b;
    public Integer c;
    public Float d;
    ...
    {
        int j = super.computeSerializedSize() + koh.e(1, a.intValue()) + koh.e(2, c.intValue()) + koh.e(3, f.intValue());
        int i = j;
        if (e != null)
        {
            e.floatValue();
