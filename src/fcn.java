...
public abstract class fcn extends Binder
    implements fcm
{

    public static fcm a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fcm))
        {
            return (fcm)iinterface;
        } else
        {
            return new fco(ibinder);
        }
    }
