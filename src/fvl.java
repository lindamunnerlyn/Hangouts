    ...
    implements android.os.Parcelable.Creator
{
    ...
    public static void a(AddListenerRequest addlistenerrequest, Parcel parcel, int i)
    {
        ...
        g.b(parcel, 1, addlistenerrequest.a);
        g.a(parcel, 2, addlistenerrequest.a());
        g.a(parcel, 3, addlistenerrequest.c, i);
        g.a(parcel, 4, addlistenerrequest.d);
        g.a(parcel, 5, addlistenerrequest.e);
        g.q(parcel, j);
    }
