    ...
    implements HttpClient
{
    ...
    private static final HttpRequestInterceptor c = new adj();
    private final HttpClient d;
    private RuntimeException e;
    private volatile qb f;

    private adi(ClientConnectionManager clientconnectionmanager, HttpParams httpparams)
    {
        e = new IllegalStateException("AndroidHttpClient created and never closed");
        d = new adk(this, clientconnectionmanager, httpparams);
    }

    public static adi a(String s, Context context, boolean flag)
    {
        Object obj = null;
        ...
        return new adi(adm.a(basichttpparams, schemeregistry, flag), basichttpparams);
    }
