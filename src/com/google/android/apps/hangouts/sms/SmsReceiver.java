...
_L4:
        ...
        {
            ebw.e("Babel_SMS", "SmsReceiver: failed to get message body ", intent);
            intent = null;
        }
        flag = flag1;
...
_L5:
        ...
        if (a == null)
        {
            s = g.a(g.nS, "babel_sms_ignore_message_regex", "VZWNMN:\\d+\n//wma::\\d+\\s//.*\nActivate:dt=\\d+\n//ANDROID:.*//CM\n\\S+\\.attwireless\\.net:\\d+\\?.*\nvvm\\.mobile\\.att\\.net:\\d+\\?.*\n");
            if (s != null)
            {
                as = s.split("\n");
                if (as.length != 0)
...
_L9:
    ...
    {
        if (android.os.Build.VERSION.SDK_INT < 19 && dbf.j() && !a(intent))
        {
