...
public class yc
{
    ...
    public yc(Context context, AttributeSet attributeset, int i1)
    {
        this(context, attributeset, i1, 0);
    }

    public yc(Context context, AttributeSet attributeset, int i1, int j1)
    {
        g = -2;
        h = -2;
        l = 0;
        ...
        B = new Rect();
        c = context;
        TypedArray typedarray = context.obtainStyledAttributes(attributeset, rq.ax, i1, j1);
        i = typedarray.getDimensionPixelOffset(rq.ay, 0);
        j = typedarray.getDimensionPixelOffset(rq.az, 0);
        if (j != 0)
        {
            k = true;
        }
        typedarray.recycle();
        d = new us(context, attributeset, i1);
...
_L1:
        ...
        f.setOnItemSelectedListener(new ye(this));
...
_L17:
    ...
    public void f(int i1)
    {
        ...
        if (n() && yf1 != null)
        {
            yf.a(yf1, false);
            yf1.setSelection(i1);
            if (android.os.Build.VERSION.SDK_INT >= 11 && yf1.getChoiceMode() != 0)
            {
                yf1.setItemChecked(i1, true);
            }
        }
    }
