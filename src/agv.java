...
public final class agv extends koj
{
    ...
    protected int computeSerializedSize()
    {
        ...
        if (A != null)
        {
            i1 = j1 + koh.e(27, A.intValue());
        }
        j1 = i1;
        if (B != null)
        {
            j1 = i1 + koh.e(28, B.intValue());
        }
        i1 = j1;
        if (C != null)
        {
            i1 = j1 + koh.e(29, C.intValue());
        }
        j1 = i1;
        if (D != null)
        {
            j1 = i1 + koh.e(30, D.intValue());
        }
        i1 = j1;
        if (E != null)
        {
            i1 = j1 + koh.e(31, E.intValue());
        }
        j1 = i1;
        if (F != null)
        {
            j1 = i1 + koh.e(32, F.intValue());
        }
        i1 = j1;
        if (G != null)
        {
...
_L40:
        int i1 = kog1.a();
        i1;
        JVM INSTR lookupswitch 38: default 320
    //                   0: 329
    //                   8: 331
    //                   16: 345
    //                   24: 359
...
_L39:
        ...
        if (true) goto _L40; else goto _L41
_L41:
    }
    ...
    public void writeTo(koh koh1)
    {
        ...
        if (A != null)
        {
            koh1.a(27, A.intValue());
        }
        if (B != null)
        {
            koh1.a(28, B.intValue());
        }
        if (C != null)
        {
            koh1.a(29, C.intValue());
        }
        if (D != null)
        {
            koh1.a(30, D.intValue());
        }
        if (E != null)
        {
            koh1.a(31, E.intValue());
        }
        if (F != null)
        {
            koh1.a(32, F.intValue());
        }
        if (G != null)
        {
            koh1.b(33, G);
