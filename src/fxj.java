...
public abstract class fxj extends Binder
    implements fxi
{
    ...
    public static fxi a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fxi))
        {
            return (fxi)iinterface;
        } else
        {
            return new fxk(ibinder);
        }
    }
