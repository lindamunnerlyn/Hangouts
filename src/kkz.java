...
public final class kkz extends koj
{
    ...
    public kop mergeFrom(kog kog1)
    {
        do
        {
            ...
            case 18: // '\022'
                ...
                if (j1 != 0)
                {
                    System.arraycopy(d, 0, aklc, 0, j1);
                    i2 = j1;
                }
                for (; i2 < aklc.length - 1; i2++)
                {
                    aklc[i2] = new klc();
                    kog1.a(aklc[i2]);
                    kog1.a();
            ...
            case 170: 
                ...
                if (k1 != 0)
                {
                    System.arraycopy(e, 0, aklb, 0, k1);
                    j2 = k1;
                }
                for (; j2 < aklb.length - 1; j2++)
                {
                    aklb[j2] = new klb();
                    kog1.a(aklb[j2]);
                    kog1.a();
            ...
            case 186: 
                ...
                if (l1 != 0)
                {
                    System.arraycopy(E, 0, aklf, 0, l1);
                    k2 = l1;
                }
                for (; k2 < aklf.length - 1; k2++)
                {
                    aklf[k2] = new klf();
                    kog1.a(aklf[k2]);
                    kog1.a();
