...
public abstract class fep extends Binder
    implements feo
{

    public static feo a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof feo))
        {
            return (feo)iinterface;
        } else
        {
            return new feq(ibinder);
        }
    }
