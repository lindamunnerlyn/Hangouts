...
public abstract class fmz extends Binder
    implements fmy
{

    public static fmy a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fmy))
        {
            return (fmy)iinterface;
        } else
        {
            return new fna(ibinder);
        }
    }
