...
public abstract class fpe extends Binder
    implements fpd
{
    ...
    public static fpd a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fpd))
        {
            return (fpd)iinterface;
        } else
        {
            return new fpf(ibinder);
        }
    }
