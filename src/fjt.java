...
public abstract class fjt extends Binder
    implements fjs
{

    public static fjs a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fjs))
        {
            return (fjs)iinterface;
        } else
        {
            return new fju(ibinder);
        }
    }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 15: // '\017'
            ...
            } else
            {
                ...
                if (obj != null && (obj instanceof fmd))
                {
                    parcel = (fmd)obj;
                } else
                {
                    parcel = new fmf(parcel);
                }
            }
            a(parcel);
            parcel1.writeNoException();
        ...
        case 16: // '\020'
            ...
            } else
            {
                ...
                if (obj != null && (obj instanceof fma))
                {
                    parcel = (fma)obj;
                } else
                {
                    parcel = new fmc(parcel);
                }
            }
            a(parcel);
            parcel1.writeNoException();
        ...
        case 18: // '\022'
            parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
            parcel = a(fcx.a(parcel.readStrongBinder()));
            parcel1.writeNoException();
            if (parcel != null)
            {
                parcel1.writeInt(1);
        ...
        } else
        {
            ...
            if (iinterface != null && (iinterface instanceof fmj))
            {
                parcel = (fmj)iinterface;
            } else
            {
                parcel = new fml(parcel);
            }
        }
        a(parcel);
        parcel1.writeNoException();
