...
public final class rz extends po
    implements uc
{
    ...
    public rz(Activity activity, boolean flag)
    {
        u = new ArrayList();
        v = -1;
        y = new ArrayList();
    ...
    private void b(View view)
    {
        ...
        if (!(obj instanceof ut)) goto _L2; else goto _L1
_L1:
        obj = (ut)obj;
_L4:
        q = ((ut) (obj));
...
_L3:
        ...
        view.f();
        g(view.d());
        view = k.obtainStyledAttributes(null, ro.a, g.g, 0);
        if (view.getBoolean(ro.k, false))
        {
            h();
        }
        i1 = view.getDimensionPixelSize(ro.i, 0);
        if (i1 != 0)
        {
            a(i1);
        }
    ...
    static ActionBarContainer c(rz rz1)
    {
        return rz1.p;
    }
    ...
    static ActionBarOverlayLayout e(rz rz1)
    {
        return rz1.o;
    }

    static boolean f(rz rz1)
    {
        return rz1.C;
    }
    ...
    static boolean g(rz rz1)
    {
        return rz1.D;
    }

    static ActionBarContextView h(rz rz1)
    {
        return rz1.r;
    }
    ...
    public vr a(vs vs1)
    {
        ...
        o.b(false);
        r.e();
        vs1 = new sd(this, r.getContext(), vs1);
        if (vs1.e())
        {
            vs1.d();
            r.a(vs1);
