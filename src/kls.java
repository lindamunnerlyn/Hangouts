...
public final class kls
{
    ...
    private static final Logger a = Logger.getLogger(kls.getName());
    ...
    private kls(byte abyte0[], int i1, int j1)
    {
        e = 0;
        b = abyte0;
        d = 0;
    ...
    public static int a(int i1, kmv kmv1)
    {
        return (q(1) << 1) + t(i1) + (q(3) + a(kmv1));
    }

    public static int a(kmv kmv1)
    {
        int i1 = kmv1.b();
        return i1 + s(i1);
    }

    public static kls a(byte abyte0[])
    {
        return new kls(abyte0, 0, abyte0.length);
    }
    ...
    public static int b(int i1, klp klp1)
    {
        return q(i1) + b(klp1);
    }
    ...
    public static int b(String s1)
    {
        ...
        {
            i1 = s1.getBytes(kmn.a).length;
        }
        return i1 + s(i1);
    }

    public static int b(klp klp1)
    {
        return s(klp1.a()) + klp1.a();
    }
    ...
    public static int d(int i1, kmy kmy1)
    {
        return (q(i1) << 1) + kmy1.m();
    }

    public static int d(kmy kmy1)
    {
        int i1 = kmy1.m();
        return i1 + s(i1);
    }
    ...
    public static int e(int i1, kmy kmy1)
    {
        return q(i1) + d(kmy1);
    }
    ...
    public static int f(int i1, kmy kmy1)
    {
        return (q(1) << 1) + t(i1) + e(3, kmy1);
    }
    ...
    public void a(int i1, klp klp1)
    {
        d(i1, 2);
        a(klp1);
    }

    public void a(int i1, kmy kmy1)
    {
        d(i1, 3);
        a(kmy1);
        d(i1, 4);
...
_L4:
        ...
        {
            a.log(Level.WARNING, "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", knt1);
        }
        s1 = s1.getBytes(kmn.a);
        r(s1.length);
        a(((byte []) (s1)), s1.length);
        return;
_L2:
...
_L3:
        ...
        throw obj;
        obj;
        throw new klt(((Throwable) (obj)));
    }

    public void a(klp klp1)
    {
        r(klp1.a());
        int i1 = klp1.a();
        if (c - d >= i1)
