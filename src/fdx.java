...
public abstract class fdx extends Binder
    implements fdw
{

    public static fdw a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fdw))
        {
            return (fdw)iinterface;
        } else
        {
            return new fdy(ibinder);
        }
    }
