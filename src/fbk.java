    ...
    implements android.os.Parcelable.Creator
{
    ...
    public static void a(GoogleHelp googlehelp, Parcel parcel, int i)
    {
        ...
        g.b(parcel, 1, googlehelp.a);
        g.a(parcel, 2, googlehelp.b);
        g.a(parcel, 3, googlehelp.c, i);
        g.a(parcel, 4, googlehelp.d);
        g.a(parcel, 5, googlehelp.h);
        g.a(parcel, 6, googlehelp.i);
        g.b(parcel, 7, googlehelp.j);
        g.a(parcel, 10, googlehelp.k);
        g.a(parcel, 11, googlehelp.l, i);
        g.a(parcel, 14, googlehelp.p);
        g.a(parcel, 15, googlehelp.q, i);
        g.b(parcel, 17, googlehelp.s);
        g.c(parcel, 16, googlehelp.r);
        g.a(parcel, 19, googlehelp.m);
        g.c(parcel, 18, googlehelp.u);
        g.b(parcel, 21, googlehelp.o);
        g.b(parcel, 20, googlehelp.n);
        g.a(parcel, 23, googlehelp.w, i);
        g.a(parcel, 22, googlehelp.v);
        g.a(parcel, 25, googlehelp.t, i);
        g.b(parcel, 29, googlehelp.f);
        g.a(parcel, 28, googlehelp.e);
        g.a(parcel, 31, googlehelp.x, i);
        g.b(parcel, 30, googlehelp.g);
        g.b(parcel, 32, googlehelp.y);
        g.a(parcel, 33, googlehelp.z, i);
        g.q(parcel, j);
    }
