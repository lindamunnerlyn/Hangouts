...
public final class hgn
{
    ...
    private static final gul a = new hgo();
    private static final gul b = new hgo();
...
_L6:
        ...
        if (bitmap1 == null)
        {
            ...
            {
                (new StringBuilder(85)).append("Failed to allocate a bitmap for roundedCornersBitmap of size: ").append(k).append("x").append(i1);
                return null;
            }
        } else
        {
