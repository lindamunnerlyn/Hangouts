    ...
    implements HttpClient
{
    ...
    private fce(Context context, String s)
    {
        boolean flag;
    ...
    private fce(Context context, String s, boolean flag, boolean flag1)
    {
        b = new fcf(this);
    ...
    public static fce a(String s, Context context)
    {
        return new fce(context, s);
    }
    ...
    private HttpResponse a(HttpURLConnection httpurlconnection)
    {
        ...
        fcg1 = new fcg();
        fcg1.a = httpurlconnection;
        fcg1.setStatusLine(HttpVersion.HTTP_1_1, i, httpurlconnection.getResponseMessage());
...
label0:
            {
                ...
                do
                {
                    ...
                    fcg1.addHeader(new BasicHeader(s3, s));
                    obj = s1;
                } while (true);
            }
        } while (true);
        ...
        if (httpurlconnection != null)
        {
            ...
            fcg1.setEntity(httpurlconnection);
        }
        return fcg1;
    }
...
_L1:
        ...
        obj = c;
        if (obj != null && ((fch) (obj)).a())
        {
            ((fch) (obj)).a(a(httpurirequest, ((fch) (obj)).a));
        }
