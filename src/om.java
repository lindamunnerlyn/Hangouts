...
public final class om extends pn
{

    final int a;
    pk b;
    final DrawerLayout c;
    private final Runnable d = new on(this);

    public om(DrawerLayout drawerlayout, int i)
    {
        c = drawerlayout;
        super();
        a = i;
...
_L3:
    ...
    {
        ((oj)view.getLayoutParams()).c = false;
        b();
    }
