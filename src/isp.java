...
_L1:
        ...
        if (!a.contains(thread) && thread != Thread.currentThread() && !iso.b().matcher(thread.getName()).matches() && !iso.a((StackTraceElement[])map.get(thread)))
        {
            hashset.add(thread);
        }
...
_L6:
        return;
_L2:
        if (!iso.a(hashset)) goto _L6; else goto _L5
_L5:
