...
_L25:
        obj1 = obj;
        ebw.g("Babel", "VolleyDiskCache: IO exception on get");
        obj1 = obj2;
        if (obj == null)
        {
...
_L4:
        obj1 = obj;
        cca1.a = b(((InputStream) (obj)));
        obj1 = obj;
        cca1.b = d(((InputStream) (obj)));
        obj1 = obj;
        cca1.c = d(((InputStream) (obj)));
        obj1 = obj;
        if (!cca1.c.equals(""))
        {
        ...
        cca1.c = null;
        obj1 = obj;
        cca1.d = c(((InputStream) (obj)));
        obj1 = obj;
        cca1.e = c(((InputStream) (obj)));
        obj1 = obj;
        cca1.f = c(((InputStream) (obj)));
        obj1 = obj;
        cca1.g = e(((InputStream) (obj)));
        obj1 = obj;
        if (cca1.b.equals(s)) goto _L6; else goto _L5
_L5:
        obj1 = obj;
...
_L6:
        obj1 = obj;
        abyte0 = a(((InputStream) (obj)), cca1.a);
        obj1 = obj;
...
_L24:
    ...
    public void a()
    {
        ...
        Object obj;
        obj;
        ebw.g("Babel", "VolleyDiskCache: IO exception on initialize");
    ...
    public void a(String s, afj afj1)
    {
        this;
        JVM INSTR monitorenter ;
...
_L2:
        outputstream = outputstream1;
        cbu cbu1 = b.b(String.valueOf(i));
        outputstream = outputstream1;
        outputstream1 = cbu1.a();
        outputstream = outputstream1;
        obj = outputstream1;
        afj1.g.put("VolleyDiskCache", "VolleyDiskCache");
        outputstream = outputstream1;
        obj = outputstream1;
        (new cca(s, afj1)).a(outputstream1);
        outputstream = outputstream1;
        obj = outputstream1;
        outputstream1.write(afj1.a);
        outputstream = outputstream1;
        obj = outputstream1;
        cbu1.b();
        outputstream1.close();
...
_L4:
        ...
        ebw.g("Babel", "VolleyDiskCache: IO exception on put");
