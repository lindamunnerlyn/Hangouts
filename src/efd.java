...
public final class efd
{
    ...
    public void a(Cursor cursor)
    {
        if (aqd.j)
        {
            ...
            ebw.b("Babel", (new StringBuilder(String.valueOf(obj).length() + 32)).append("[MessageListState] setNewCursor ").append(((String) (obj))).toString());
        }
        this;
        ...
        if (aqd.j)
        {
            ...
            ebw.b("Babel", (new StringBuilder(String.valueOf(cursor).length() + 26)).append("[MessageListState] newIds ").append(cursor).toString());
        }
        d = false;
        this;
    ...
    public void a(MessageListItemWrapperView messagelistitemwrapperview)
    {
        ...
        {
            ebw.f("Babel", "[MessageCursorAdapter] onRevealFinished called when the new message queue was empty.");
            return;
        }
    }
