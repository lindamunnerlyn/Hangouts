...
public final class lnb extends BroadcastReceiver
{

    final ProxyChangeListener a;

    public lnb(ProxyChangeListener proxychangelistener)
    {
        a = proxychangelistener;
        super();
    }

    private static lna a(Intent intent)
    {
        Object obj;
        Object obj1;
        Class class1;
        ...
        if (android.os.Build.VERSION.SDK_INT == 19)
        {
            ...
            {
                return new lna(((String) (obj)), i, ((String) (obj1)), intent);
            }
        ...
        if (android.os.Build.VERSION.SDK_INT > 19)
        {
            ...
            {
                return new lna(((String) (obj)), i, ((Uri) (obj1)).toString(), intent);
            }
        }
        intent = new lna(((String) (obj)), i, null, intent);
        return intent;
    }
