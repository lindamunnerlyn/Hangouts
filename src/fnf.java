...
public abstract class fnf extends Binder
    implements fne
{

    public static fne a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fne))
        {
            return (fne)iinterface;
        } else
        {
            return new fng(ibinder);
        }
    }
