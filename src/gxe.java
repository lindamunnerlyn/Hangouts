    ...
    implements Parcelable
{
    ...
    public static final android.os.Parcelable.Creator CREATOR = new gxf();
    public String a;
    public String b;
    public int c;
    public boolean d;
    ...
    public gxe(Parcel parcel)
    {
        ...
        p = parcel.readString();
        q = parcel.readString();
        r = (gwp)parcel.readParcelable(getClass().getClassLoader());
...
_L1:
    ...
    public gxe a(Context context, Intent intent)
    {
        String s1;
        Object obj;
        k = intent.getIntExtra("account_id", -1);
        context = ((fxi)hgx.a(context, fxi)).a(context, intent);
        if (context != null)
        {
            l = ((fxj) (context)).a;
            m = ((fxj) (context)).b;
...
_L3:
    ...
    public gxe a(Class class1)
    {
        return a(class1, ((Bundle) (null)));
    }

    public gxe a(Class class1, Bundle bundle)
    {
        s = class1;
        t = bundle;
        return this;
    ...
    public gxe a(String s1)
    {
        o = s1;
        return this;
    }

    public gxe a(String s1, String s2)
    {
        o = s1;
        p = s2;
        return this;
