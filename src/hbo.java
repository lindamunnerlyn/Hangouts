    ...
    implements Parcelable
{
    ...
    public static final android.os.Parcelable.Creator CREATOR = new hbp();
    public String a;
    public String b;
    public int c;
    public boolean d;
    ...
    public hbo(Parcel parcel)
    {
        ...
        p = parcel.readString();
        q = parcel.readString();
        r = (haz)parcel.readParcelable(getClass().getClassLoader());
...
_L1:
    ...
    public hbo a(Context context, Intent intent)
    {
        String s1;
        Object obj;
        k = intent.getIntExtra("account_id", -1);
        context = ((fzm)hlp.a(context, fzm)).a(context, intent);
        if (context != null)
        {
            l = ((fzn) (context)).a;
            m = ((fzn) (context)).b;
...
_L3:
    ...
    public hbo a(Class class1)
    {
        return a(class1, ((Bundle) (null)));
    }

    public hbo a(Class class1, Bundle bundle)
    {
        s = class1;
        t = bundle;
        return this;
    ...
    public hbo a(String s1)
    {
        o = s1;
        return this;
    }

    public hbo a(String s1, String s2)
    {
        o = s1;
        p = s2;
        return this;
