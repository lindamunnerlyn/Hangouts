...
public final class acp
{
    ...
    {
        Integer integer = (Integer)a.get(i);
        if (integer == null)
        {
            return 0;
        } else
...
_L2:
        ...
        if (129 != i)
        {
            throw new aby("Invalid Octet value!");
        }
        break; /* Loop/switch isn't completed */
_L9:
        k = i;
...
_L19:
    ...
    protected void a(ace ace1, int i)
    {
        if (ace1 == null)
        {
    ...
    protected void a(ace aace[])
    {
        ...
        for (int i = 0; i < aace.length; i++)
        {
            arraylist.add(aace[i]);
        }

        a.put(151, arraylist);
    }

    protected void b(ace ace1, int i)
    {
        if (ace1 == null)
        {
            throw new NullPointerException();
    ...
    protected ace c(int i)
    {
        return (ace)a.get(i);
    }

    protected ace[] d(int i)
    {
