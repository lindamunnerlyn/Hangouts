...
public final class aps extends SQLiteOpenHelper
{
    ...
    private aps(Context context, int j)
    {
        String s = String.valueOf("babel");
        String s1 = String.valueOf(".db");
        super(context, (new StringBuilder(String.valueOf(s).length() + 11 + String.valueOf(s1).length())).append(s).append(j).append(s1).toString(), null, 1070);
        a = context;
        f = j;
...
_L5:
    ...
    public static aps a(Context context, int j)
    {
        aps aps1;
        Map map;
        g.w();
        ...
        try
        {
            grb1 = ((gqz)hlp.a(context, gqz)).a(j);
        }
        // Misplaced declaration of an exception variable
        catch (Context context)
        {
            throw new apu(context);
        }
        map = d;
        map;
        JVM INSTR monitorenter ;
        aps2 = (aps)d.get(Integer.valueOf(j));
        aps1 = aps2;
        if (aps2 != null)
        {
            break MISSING_BLOCK_LABEL_175;
        }
        if (!grb1.d("sms_only") && !grb1.a())
        {
            context = String.valueOf(eev.b(grb1.b("account_name")));
            eev.g("Babel", (new StringBuilder(String.valueOf(context).length() + 22)).append("Account ").append(context).append(" not logged in").toString());
            throw new apu();
        }
        ...
        throw context;
        aps1 = new aps(context, j);
        d.put(Integer.valueOf(j), aps1);
        map;
        JVM INSTR monitorexit ;
        return aps1;
    }

    private static cgd a(Context context, SQLiteDatabase sqlitedatabase)
    {
        ...
        try
        {
            context = aoc.a(context, Integer.parseInt(sqlitedatabase.substring(5, sqlitedatabase.length() - 3)));
        }
        // Misplaced declaration of an exception variable
        catch (Context context)
        {
    ...
    private static String a(SQLiteDatabase sqlitedatabase, cgd cgd1, Map map)
    {
        Object obj;
        Object obj1;
        Object obj2;
...
_L4:
        map = obj;
        if (!(obj3 instanceof eec)) goto _L2; else goto _L5
_L5:
        ...
        do
        {
            ...
            if (obj4 instanceof cgd)
            {
                obj4 = (cgd)obj4;
                Object obj5 = ((eec) (obj3)).get(obj4);
                if (obj5 != null && (obj5 instanceof String))
                {
                    int j = a(sqlitedatabase, ((cgd) (obj4)).a, ((cgd) (obj4)).b, null, null, (String)obj5);
                    if (j >= 0)
                    {
                        if (map.length() > 0)
                        {
        ...
        if (cgd1 == null || obj1 == null || !(obj1 instanceof String) || ((List) (obj2)).size() != 1) goto _L7; else goto _L6
_L6:
        obj2 = ((List) (obj2)).get(0);
        if (!(obj2 instanceof cgd) || !cgd1.a((cgd)obj2)) goto _L7; else goto _L8
_L8:
...
_L10:
    ...
    private static String a(SQLiteDatabase sqlitedatabase, Map map, boolean flag)
    {
        ...
        if (flag && obj != null && (obj instanceof List))
        {
            ...
            do
            {
                ...
                Object obj2;
                int j;
                if (obj1 != null && (obj1 instanceof dbl))
                {
                    obj1 = (dbl)obj1;
                    j = a(sqlitedatabase, ((dbl) (obj1)).a, ((dbl) (obj1)).b, ((dbl) (obj1)).d, ((dbl) (obj1)).c, ((dbl) (obj1)).e);
                } else
                {
                    j = -1;
                }
            ...
            if (obj2 != null)
            {
                ...
                if (obj2 instanceof List)
                {
                    ...
                    do
                    {
                        ...
                        if (obj2 instanceof cgd)
                        {
                            obj2 = (cgd)obj2;
                            j = a(sqlitedatabase, ((cgd) (obj2)).a, ((cgd) (obj2)).b, null, null, null);
                        } else
                        {
                            j = -1;
                        }
    ...
    private static String a(Map map)
    {
        ...
        {
            eev.e("Babel", "got exception serializing strings array", map);
            return null;
        }
        return map;
    }
    ...
    private static Map a(String s)
    {
        ...
        return s;
        s;
        eev.e("Babel", "error decoding", s);
        return null;
        s;
        eev.e("Babel", "decode object failure", s);
        return null;
    }
    ...
    private static void a(SQLiteDatabase sqlitedatabase)
    {
        ...
        do
        {
            ...
            if (s.matches("^\\+?[0-9]+$"))
            {
                ...
                contentvalues.put("generated_name", eey.p(s));
...
_L6:
    ...
    {
        Object obj = (gqz)hlp.a(context, gqz);
        String s;
        boolean flag;
        if (!((gqz) (obj)).c(j) || !((gqz) (obj)).a(j).a())
        {
            flag = true;
        } else
        {
        ...
        eev.e("Babel", (new StringBuilder(30)).append("deleted: ").append(flag).append(" for ").append(j).toString());
        synchronized (d)
        {
...
_L1:
        Object obj;
        Map map;
        obj = dsv.values()[((Cursor) (obj1)).getInt(1)];
        contentvalues.clear();
...
_L4:
        if (obj == dsv.e)
        {
            contentvalues.put("type", Integer.valueOf(dsv.m.ordinal()));
...
_L17:
        obj = dsv.l;
          goto _L19
_L37:
        contentvalues.put("type", Integer.valueOf(((dsv) (obj)).ordinal()));
_L36:
        boolean flag;
...
_L18:
        obj = dsv.m;
          goto _L19
_L11:
        obj = a(sqlitedatabase, ((cgd) (obj2)), map);
...
_L10:
        ...
        Throwable throwable;
        throwable;
        eev.e("Babel", "couldn't rebuild views -- will rebuild whole db", throwable);
        flag = false;
...
_L2:
        ...
        eev.c("Babel", (new StringBuilder(String.valueOf(s2).length() + 22 + String.valueOf(s1).length())).append("unable to drop table ").append(s2).append(" ").append(s1).toString());
          goto _L1
        sqlitedatabase;
        cursor.close();
        throw sqlitedatabase;
...
_L7:
        ...
        if (eev.a("Babel", 3))
        {
            ...
            eev.c("Babel", (new StringBuilder(String.valueOf(s).length() + 21 + String.valueOf(obj).length())).append("unable to drop view ").append(s).append(" ").append(((String) (obj))).toString());
        }
        continue; /* Loop/switch isn't completed */
        sqlitedatabase;
        cursor.close();
...
_L7:
        ...
        {
            obj = String.valueOf(obj);
            eev.c("Babel", (new StringBuilder(String.valueOf(s).length() + 22 + String.valueOf(obj).length())).append("unable to drop index ").append(s).append(" ").append(((String) (obj))).toString());
        }
        continue; /* Loop/switch isn't completed */
        sqlitedatabase;
        cursor.close();
...
_L8:
    ...
    public apv a()
    {
        this;
        JVM INSTR monitorenter ;
        apv apv1 = apv.a(a, getReadableDatabase());
        this;
        JVM INSTR monitorexit ;
        return apv1;
        Exception exception;
    ...
    public apv b()
    {
        this;
        JVM INSTR monitorenter ;
        apv apv1 = apv.a(a, getWritableDatabase());
        this;
        JVM INSTR monitorexit ;
        return apv1;
        Exception exception;
    ...
    public void c()
    {
        if (b)
        {
            eev.b("Babel", "[EsDatabaseHelper] createNewDatabase");
        }
        e = false;
    }
...
label0:
        {
            ...
            eev.f("Babel", (new StringBuilder(String.valueOf(s).length() + 56)).append("[EsDatabaseHelper] getWritableDatabase threw exception: ").append(s).toString());
...
label0:
    ...
    {
        eev.g("Babel", (new StringBuilder(43)).append("Downgrading from:").append(j).append(" to:").append(k).toString());
        f(sqlitedatabase);
        if (android.os.Build.VERSION.SDK_INT >= 19)
        {
            sqlitedatabase = (ActivityManager)a.getSystemService("activity");
            eev.g("Babel", "Clearing app data, service will be restarted!");
    ...
    public void onUpgrade(SQLiteDatabase sqlitedatabase, int j, int k)
    {
        ...
        if (eev.a("Babel", 3))
        {
            eev.c("Babel", (new StringBuilder(45)).append("Upgrade database: ").append(j).append(" --> ").append(k).toString());
        }
        char c1 = '\362';
        ...
        {
            eev.f("Babel", (new StringBuilder(50)).append("upgrade from ").append(j).append(" not supported; recreating").toString());
            f(sqlitedatabase);
            return;
        }
        j;
        JVM INSTR lookupswitch 133: default 1228
    //                   138: 1350
    //                   200: 1524
    //                   203: 1524
    //                   204: 1531
...
_L1:
        ...
        catch (Object obj)
        {
            ...
            eev.e("Babel", (new StringBuilder(String.valueOf(s).length() + 46)).append("Upgrade database: ").append(j).append(" --> ").append(k).append(" ").append(s).toString(), ((Throwable) (obj)));
            flag = false;
        }
          goto _L77
_L2:
...
_L78:
        ...
        l++;
        if (true) goto _L78; else goto _L73
_L73:
...
_L75:
        sqlitedatabase.execSQL("alter table messages add column observed_status INT DEFAULT(2);");
_L76:
        e(sqlitedatabase);
        aow.a(new aow(a, new apv(a, sqlitedatabase), f), null);
        flag = flag1;
_L80:
        if (flag)
        {
            eev.e("Babel", (new StringBuilder(52)).append("db upgrade from ").append(j).append(" to ").append(k).append(" succeeded").toString());
            return;
        }
        break; /* Loop/switch isn't completed */
        eev.f("Babel", (new StringBuilder(52)).append("db upgrade not supported: ").append(j).append(" -> ").append(k).toString());
        flag = false;
        continue; /* Loop/switch isn't completed */
_L77:
...
_L79:
        ...
        {
            eev.f("Babel", (new StringBuilder(57)).append("db upgrade failed; recreating: ").append(j).append(" -> ").append(k).toString());
            f(sqlitedatabase);
            return;
        }
    }
