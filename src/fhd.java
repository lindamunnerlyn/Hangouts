...
public abstract class fhd extends Binder
    implements fhc
{

    public static fhc a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fhc))
        {
            return (fhc)iinterface;
        } else
        {
            return new fhe(ibinder);
        }
    }
