    ...
    implements android.view.View.OnTouchListener
{
    ...
    private boolean a(MotionEvent motionevent)
    {
        ...
        View view = d;
        Object obj = a();
        if (obj == null || !((ya) (obj)).n())
        {
            flag1 = false;
        } else
        {
            obj = ya.a(((ya) (obj)));
            if (obj == null || !((yd) (obj)).isShown())
            {
                return false;
            }
            ...
            boolean flag2 = ((yd) (obj)).a(motionevent1, i);
    ...
    static void b(ye ye1)
    {
        ye1.d();
        View view;
        for (view = ye1.d; !view.isEnabled() || view.isLongClickable() || !ye1.b();)
        {
            return;
        }
