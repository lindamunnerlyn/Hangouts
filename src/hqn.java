...
final class hqn
{
    ...
    hqn(InputStream inputstream, String s, List list, boolean flag)
    {
        a = true;
        b = new ArrayList();
        g = 0;
    ...
    private static Object a(Class class1, HttpResponse httpresponse, hqm hqm1)
    {
        ...
        {
            return hqm1.d.getParser().parseAndClose(httpresponse.getContent(), httpresponse.getContentCharset(), class1);
        }
    }
    ...
    void a()
    {
        ...
        {
            abyte0 = new hqo(this, g.b(f, l));
        }
        obj1 = (new hqr(k, abyte0, ((List) (obj1)), ((List) (obj2)))).createRequestFactory().buildPostRequest(new GenericUrl("http://google.com/"), null);
        ...
        httpunsuccessfulresponsehandler = ((hqm) (obj2)).d.getUnsuccessfulResponseHandler();
        backoffpolicy = ((hqm) (obj2)).d.getBackOffPolicy();
        c = false;
        if (!HttpStatusCodes.isSuccess(k)) goto _L2; else goto _L1
_L1:
        if (hqj1 != null)
        {
            hqj1.a(a(((hqm) (obj2)).b, ((HttpResponse) (obj1)), ((hqm) (obj2))), httpheaders);
        }
_L9:
        ...
        for (; s != null && s.length() == 0; s = a(b())) { }
        break; /* Loop/switch isn't completed */
_L2:
        boolean flag;
        boolean flag1;
        boolean flag2;
        HttpContent httpcontent = ((hqm) (obj2)).d.getContent();
        boolean flag3;
        ...
        {
            flag3 = httpunsuccessfulresponsehandler.handleResponse(((hqm) (obj2)).d, ((HttpResponse) (obj1)), flag2);
        }
        flag = flag1;
        if (flag3) goto _L4; else goto _L3
_L3:
        if (!((hqm) (obj2)).d.handleRedirect(((HttpResponse) (obj1)).getStatusCode(), ((HttpResponse) (obj1)).getHeaders())) goto _L6; else goto _L5
_L5:
        flag = true;
_L4:
...
_L7:
        if (hqj1 != null)
        {
            a(((hqm) (obj2)).c, ((HttpResponse) (obj1)), ((hqm) (obj2)));
            hqj1.a();
        }
