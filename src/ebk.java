...
public final class ebk
{
    ...
    public static boolean a(Context context, String s)
    {
        ...
        ebw.g("Babel", (new StringBuilder(40)).append("Self signed with ").append(i).append(" signatures.").toString());
        return false;
        Signature signature;
...
_L1:
        ...
        ebw.g("Babel", "Package signed with < 1 signature.");
        return false;
        ...
        {
            ebw.e("Babel", "checkForValidSignature caught", context);
            return false;
        }
        // Misplaced declaration of an exception variable
        catch (Context context)
...
_L5:
        ...
        {
            ebw.c("Babel", "Found a match in the allowed signatures.");
...
_L4:
        ...
        {
            ebw.c("Babel", "Signature matches self signature.");
            break MISSING_BLOCK_LABEL_384;
        }
        ebw.c("Babel", "Unrecognized signature found.");
        return false;
        ebw.c("Babel", "Signature is valid.");
        return true;
        j++;
