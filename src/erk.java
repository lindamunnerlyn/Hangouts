...
public final class erk
{
    ...
    private erk()
    {
        ...
        f = ((List) (obj));
        h = new ero(((Long)erm.f.d()).longValue());
    }
        ...
        if (epx.a)
        {
            ...
            } else
            {
                ...
                } else
                {
                    ...
                    if (c.contains(serviceconnection) || d.contains(s) || e.contains(s2) || f.contains(obj) || s2.equals(serviceconnection) && (k & ern.f) != 0)
                    {
                        k = 0;
                    } else
                    {
...
_L1:
        int j;
        if (epx.a && fgx.b() && fgx.a() == Process.myUid())
        {
            j = 1;
        } else
        {
...
_L4:
    ...
    public boolean a(Context context, String s, Intent intent, ServiceConnection serviceconnection)
    {
        ...
        boolean flag;
        if (componentname == null || epx.a && "com.google.android.gms".equals(componentname.getPackageName()))
        {
            flag = false;
        } else
        {
