...
public final class gxa
{
    ...
    private static final ThreadLocal b = new gxb();
    private static final String c[] = new String[0];
    private static final ThreadLocal d = new gxc();
    private static final ThreadLocal e = new gxd();
    private static final ThreadLocal f = new gxe();
