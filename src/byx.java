...
public final class byx
{
    ...
    public byx(Resources resources, VelocityTracker velocitytracker, bzc bzc1, float f1, float f2)
    {
        w = new gz();
        k = bzc1;
        m = velocitytracker;
        ...
        if (c == -1)
        {
            c = resources.getInteger(g.mT);
            d = resources.getInteger(g.mP);
            e = resources.getInteger(g.mR);
            f = resources.getInteger(g.mQ);
            g = resources.getInteger(g.mS);
            h = resources.getDimension(g.mN);
            i = resources.getDimension(g.mO);
        }
    }
...
_L9:
        ...
        if (i1 != 0)
        {
            ...
            objectanimator.addListener(new byy(this, view, motionevent));
            objectanimator.addUpdateListener(new byz(this, view));
        ...
        } else
        {
            ...
            objectanimator1.addUpdateListener(new bza(this, view1));
            objectanimator1.addListener(new bzb(this, motionevent, objectanimator1, view1));
