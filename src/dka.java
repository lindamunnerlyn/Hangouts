...
public final class dka extends BroadcastReceiver
    implements Runnable
{
    ...
    public dka(hgx hgx1, RequestWriter requestwriter)
    {
        b = 0L;
        d = requestwriter;
        e = hgx1;
        c = ((alw)e.a(alw)).a("babel_retry_on_network_connectivity_ms", 0x493e0L);
        g.a(g.nS).a(this);
    }
...
_L2:
        ...
        synchronized (drb.a())
        {
            ...
            ebw.e("Babel_SMS", "MmsSendReceiveManager: no sender, skip checking");
        }
        return;
        context;
        intent;
        ...
        ebw.e("Babel_SMS", (new StringBuilder(String.valueOf(s).length() + 47)).append("MmsSendReceiveManager: MMS connectivity change ").append(s).toString());
        ...
        ebw.g("Babel_SMS", (new StringBuilder(String.valueOf(context).length() + 53)).append("MmsSendReceiveManager.ConnectivityBroadcastReceiver: ").append(context).toString());
        return;
        if (intent.getState() == android.net.NetworkInfo.State.CONNECTED)
        {
            intent = dsj.a(context, intent.getExtraInfo());
            if (intent.b())
            {
                synchronized (drb.a())
                {
        ...
        {
            if (intent.getState() == android.net.NetworkInfo.State.DISCONNECTED && !drb.a(connectivitymanager))
            {
                synchronized (drb.a())
                {
                    drb.a();
                    dre.a(false, new dra(123, "Mobile data is disabled and can not connect MMS"));
                    drb.a().d = null;
                }
                return;
            }
