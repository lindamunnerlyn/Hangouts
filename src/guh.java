...
public final class guh
{
    ...
    public guh(Context context, String s, long l, long l1, float f1, 
            float f2)
    {
        Object obj;
        ...
        this(context, s, l, l1, f1, f2, ((guj) (obj)));
    }

    private guh(Context context, String s, long l, long l1, float f1, 
            float f2, guj guj1)
    {
        a = context;
        b = s;
