    ...
    implements fgw
{
    ...
    public StreetViewPanoramaOrientation a(ezy ezy1)
    {
        Object obj;
        Parcel parcel;
        Parcel parcel1;
...
_L1:
        ...
        {
            ezy1 = StreetViewPanoramaOrientation.CREATOR;
            ezy1 = flp.a(parcel1);
        }
        parcel1.recycle();
        parcel.recycle();
    ...
    public ezy a(StreetViewPanoramaOrientation streetviewpanoramaorientation)
    {
        Parcel parcel;
        Parcel parcel1;
        parcel = Parcel.obtain();
...
_L1:
        ...
        parcel1.readException();
        streetviewpanoramaorientation = ezz.a(parcel1.readStrongBinder());
        parcel1.recycle();
        parcel.recycle();
