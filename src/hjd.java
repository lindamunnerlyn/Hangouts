...
public final class hjd extends CheckBoxPreference
{

    private final hje c;

    public hjd(Context context, int i, String s)
    {
        this(context, i, s, null);
    }

    public hjd(Context context, int i, String s, Boolean boolean1)
    {
        super(context);
