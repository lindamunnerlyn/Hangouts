...
public final class apd
{
    ...
    private static ThreadLocal b = new ape();
    ...
    apd(Context context, SQLiteDatabase sqlitedatabase)
    {
        e = context;
        d = sqlitedatabase;
    }

    public static apd a(Context context, SQLiteDatabase sqlitedatabase)
    {
        apd;
        JVM INSTR monitorenter ;
        if (a == null || a.d != sqlitedatabase)
        {
            a = new apd(context, sqlitedatabase);
        }
        context = a;
        apd;
    ...
    private static void a(long l, String s)
    {
        ...
        if (l > 250L)
        {
            ebw.a("Babel", String.format(Locale.US, c[Math.min(c.length - 1, i)], new Object[] {
                Long.valueOf(l), s
            }));
        }
    }
...
_L2:
        ...
        if (sqlitequerybuilder.moveToFirst())
        {
            ...
            ebw.a("Babel", (new StringBuilder(String.valueOf(as).length() + 20 + String.valueOf(sqlitedatabase).length())).append("for query ").append(as).append("\nplan is: ").append(sqlitedatabase).toString());
        }
...
_L3:
        ...
        return;
        sqlitedatabase;
        ebw.d("Babel", "Query plan failed ", sqlitedatabase);
...
_L4:
    ...
    private String f()
    {
        return ((alw)hgx.a(e, alw)).a("babel_query_plan_regexp", null);
    }
    ...
    {
        long l1 = 0L;
        apf apf1 = (apf)((Stack)b.get()).pop();
        if (!apf1.b)
        {
            ebw.f("Babel", "endTransaction without setting successful");
    ...
    public void d()
    {
        ...
        if (d.yieldIfContendedSafely() && apa.d())
        {
