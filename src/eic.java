...
public final class eic
{
    ...
    private static void a(Context context)
    {
        ...
        {
            throw new eid(context.a(), context.getMessage(), context.b());
        }
        // Misplaced declaration of an exception variable
        catch (Context context)
        {
            throw new eib(context.getMessage());
        }
    }
    ...
    private static Bundle b(Context context, Account account, String s, Bundle bundle)
    {
        ...
        context = new eou();
        obj = enm.a(((Context) (obj)));
        if (!((enm) (obj)).a(c, context, "GoogleAuthUtil"))
        {
            break MISSING_BLOCK_LABEL_448;
        }
        s = fdx.a(context.a()).a(account, s, bundle);
        if (s != null)
        {
            break MISSING_BLOCK_LABEL_160;
        }
        throw new eib("ServiceUnavailable");
        account;
        throw new IOException("remote exception");
        account;
        ((enm) (obj)).b(c, context, "GoogleAuthUtil");
        throw account;
        ...
        boolean flag;
        if (!"BadAuthentication".equals(account) && !"CaptchaRequired".equals(account) && !"DeviceManagementRequiredOrSyncDisabled".equals(account) && !"NeedPermission".equals(account) && !"NeedsBrowser".equals(account) && !"UserCancel".equals(account) && !"AppDownloadRequired".equals(account) && !eig.u.a().equals(account) && !eig.v.a().equals(account) && !eig.w.a().equals(account) && !eig.x.a().equals(account) && !eig.y.a().equals(account) && !eig.z.a().equals(account) && !eig.s.a().equals(account))
        {
            flag = false;
        } else
        {
        ...
        throw new eie(account, s);
        account;
        throw new eib("Interrupted");
    ...
    public static void b(Context context, String s)
    {
        ...
        s = fdx.a(context.a()).a(s, ((Bundle) (obj1)));
        obj1 = s.getString("Error");
        if (!s.getBoolean("booleanResult"))
        {
            throw new eib(((String) (obj1)));
        }
    ...
    private static Bundle c(Context context, Account account, String s, Bundle bundle)
    {
        ...
        {
            ejn.a(account.a(), context);
            throw new eif("User intervention required. Notification has been pushed.");
        }
        // Misplaced declaration of an exception variable
        catch (Account account)
        {
...
_L5:
    ...
    private static Account[] d(Context context, String s)
    {
        int i;
        i = 0;
        context = ((Context)h.a(context)).getContentResolver().acquireContentProviderClient("com.google.android.gms.auth.accounts");
        if (context == null)
        {
