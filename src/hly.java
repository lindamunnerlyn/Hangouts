...
public final class hly
{
    ...
    public hly(AbstractInputStreamContent abstractinputstreamcontent, HttpTransport httptransport, HttpRequestInitializer httprequestinitializer)
    {
        c = hlz.a;
        j = "POST";
        k = new HttpHeaders();
        ...
        p = 0xa00000;
        b = hod.a;
        d = (AbstractInputStreamContent)h.b(abstractinputstreamcontent);
        f = (HttpTransport)h.b(httptransport);
...
_L10:
    ...
    public hly a(HttpContent httpcontent)
    {
        g = httpcontent;
        return this;
    }
