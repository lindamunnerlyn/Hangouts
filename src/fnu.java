...
public abstract class fnu extends Binder
    implements fnt
{

    public static fnt a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fnt))
        {
            return (fnt)iinterface;
        } else
        {
            return new fnv(ibinder);
        }
    }
