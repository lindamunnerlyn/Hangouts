...
_L4:
        ...
        if (aprovider.length > 0 && glz.equals(aprovider[0].getClass()))
        {
            break MISSING_BLOCK_LABEL_67;
        }
        Security.insertProviderAt(new glz(), 1);
        Object obj = new SecureRandom();
        if (!glz.equals(((SecureRandom) (obj)).getProvider().getClass()))
        {
...
_L6:
        ...
        if (!glz.equals(((SecureRandom) (obj2)).getProvider().getClass()))
        {
