...
public abstract class fvd extends Binder
    implements fvc
{
    ...
    public static fvc a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fvc))
        {
            return (fvc)iinterface;
        } else
        {
            return new fve(ibinder);
        }
    }
