...
public abstract class fkd extends Binder
    implements fkc
{

    public static fkc a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fkc))
        {
            return (fkc)iinterface;
        } else
        {
            return new fke(ibinder);
        }
    }
