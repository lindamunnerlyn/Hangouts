...
public final class ijd extends koj
{
...
_L6:
        ...
        if (i1 != 0)
        {
            System.arraycopy(d, 0, aijf, 0, i1);
            j1 = i1;
        }
        for (; j1 < aijf.length - 1; j1++)
        {
            aijf[j1] = new ijf();
            kog1.a(aijf[j1]);
            kog1.a();
...
_L7:
        ...
        if (i1 != 0)
        {
            System.arraycopy(e, 0, aijf1, 0, i1);
            k1 = i1;
        }
        for (; k1 < aijf1.length - 1; k1++)
        {
            aijf1[k1] = new ijf();
            kog1.a(aijf1[k1]);
            kog1.a();
...
_L26:
        ...
        if (i1 != 0)
        {
            System.arraycopy(x, 0, akrb, 0, i1);
            i2 = i1;
        }
        for (; i2 < akrb.length - 1; i2++)
        {
            akrb[i2] = new krb();
            kog1.a(akrb[i2]);
            kog1.a();
...
_L29:
        ...
        if (i1 != 0)
        {
            System.arraycopy(A, 0, akpa, 0, i1);
            j2 = i1;
        }
        for (; j2 < akpa.length - 1; j2++)
        {
            akpa[j2] = new kpa();
            kog1.a(akpa[j2]);
            kog1.a();
