...
public final class dvk
{
    ...
    public dvk(TeleConnectionService teleconnectionservice, ConnectionRequest connectionrequest, dvh dvh1, boolean flag)
    {
    ...
    private boolean a(boolean flag)
    {
        ...
        {
            ebw.e("Babel_telephony", "TelePhoneNumber.shouldUseProxyNumber, disabled by gservices.");
            return false;
        }
        if (g.a(a, "babel_telephony_force_proxy_number_fetch", false))
        {
            ebw.e("Babel_telephony", "TelePhoneNumber.shouldUseProxyNumber, forcing proxy number fetch.");
            return true;
        }
        if (f != 1)
        {
        ...
        if (m())
        {
            ebw.e("Babel_telephony", "TelePhoneNumber.shouldUseProxyNumber, GoogleVoice request");
            return false;
        }
        if (dwz.a(a).e() == -1)
        {
            ebw.e("Babel_telephony", "TelePhoneNumber.shouldUseProxyNumber, no Tycho account.");
            return false;
        }
        if (ebz.j(c()))
        {
            ebw.e("Babel_telephony", "TelePhoneNumber.shouldUseProxyNumber, emergency number");
            return false;
        }
        if (PhoneNumberUtils.formatNumberToE164(c(), ebz.k()) == null)
        {
        ...
        if (d.e() == 3)
        {
            ebw.e("Babel_telephony", "TelePhoneNumber.shouldUseProxyNumber, can't tell if we're international.");
            return false;
        }
        if (d.a() == 3)
        {
            ebw.e("Babel_telephony", "TelePhoneNumber.shouldUseProxyNumber, can't tell if we're roaming.");
            return false;
        } else
        {
            ebw.e("Babel_telephony", "TelePhoneNumber.shouldUseProxyNumber, true");
            return true;
        }
    }
...
label0:
        {
            String s2 = g.a(a, "babel_telephony_remapped_phone_numbers", dul.b);
            Object obj = s;
            ...
            s = g.u(s);
            s1 = g.u(((String) (obj)));
            ebw.e("Babel_telephony", (new StringBuilder(String.valueOf(s).length() + 54 + String.valueOf(s1).length())).append("TelePhoneNumber.maybeRemapPhoneNumber, remapped: ").append(s).append(" to: ").append(s1).toString());
            g = true;
        }
        return ((String) (obj));
    }
...
_L4:
        return true;
        ebw.f("Babel_telephony", "TeleUtils.isNorthAmericanNumberFormat, got null dialStr");
        return false;
    }
...
label2:
    ...
    boolean m()
    {
        ...
        {
            ebw.e("Babel_telephony", "TeleUtils.isGoogleVoiceRequest, no extras");
            return false;
        }
    ...
    boolean q()
    {
        ...
        {
            ebw.e("Babel_telephony", "TelePhoneNumber.shouldAnonymizeCall, disabled by gservices");
            return false;
        }
        String s1 = d.b();
        if (!TextUtils.isEmpty(s1))
        ...
        if (!a(false))
        {
            ebw.e("Babel_telephony", "TelePhoneNumber.shouldAnonymizeCall, doesn't need proxy number");
            return false;
        }
        if (e != null)
        {
            ebw.e("Babel_telephony", "TelePhoneNumber.shouldAnonymizeCall, has proxy number");
            return false;
        }
        if (d.c() == 2)
        {
            ebw.e("Babel_telephony", "TelePhoneNumber.shouldAnonymizeCall, on light profile");
            return false;
        } else
        {
            ebw.e("Babel_telephony", "TelePhoneNumber.shouldAnonymizeCall, returning true");
            return true;
        }
    }
}
