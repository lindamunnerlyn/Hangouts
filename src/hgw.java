    ...
    implements hhe
{
    ...
    public hgw(Context context, Set set)
    {
        ...
        c = (hhe[])((List) (obj1)).toArray(new hhe[((List) (obj1)).size()]);
    }

    private static hhe a(String s)
    {
        hhe hhe1;
        try
        {
            hhe1 = (hhe)Class.forName(s).newInstance();
        }
