    ...
    implements HttpUrlRequestListener
{
    ...
    public hdp(Context context, hdx hdx1, String s1, hdt hdt1)
    {
        this(context, hdx1, s1, hdt1, (byte)0);
    }

    private hdp(Context context, hdx hdx1, String s1, hdt hdt1, byte byte0)
    {
        i = b.getAndIncrement();
...
_L3:
    ...
    {
        if (!(exception instanceof hdm)) goto _L2; else goto _L1
_L1:
        ((hdm)exception).a();
...
_L5:
    ...
    protected void q()
    {
        ...
        if ((obj instanceof hdm) && ((hdm)obj).a() == 401)
        {
            flag = true;
        } else
        {
