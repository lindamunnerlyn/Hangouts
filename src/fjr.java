...
public abstract class fjr extends Binder
    implements fjq
{

    public static fjq a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fjq))
        {
            return (fjq)iinterface;
        } else
        {
            return new fjs(ibinder);
        }
    }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 1: // '\001'
            ...
            a(fgx.a(parcel.readStrongBinder()));
