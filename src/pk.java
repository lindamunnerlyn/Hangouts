...
public final class pk
{
    ...
    private static final Interpolator v = new pl();
    private int a;
    private int b;
    private int c;
    private float d[];
    ...
    private final Runnable w = new pm(this);

    private pk(Context context, ViewGroup viewgroup, pn pn1)
    {
        c = -1;
        if (viewgroup == null)
        {
    ...
    public static pk a(ViewGroup viewgroup, pn pn1)
    {
        viewgroup = new pk(viewgroup.getContext(), viewgroup, pn1);
        viewgroup.b = (int)(float)((pk) (viewgroup)).b;
        return viewgroup;
    }
