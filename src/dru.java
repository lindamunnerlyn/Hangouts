...
public final class dru
{
    ...
    private static int a(Context context, String s, String s1, long l, String s2, boolean flag, long l1)
    {
        ...
        {
            throw new drp("SmsSender: empty destination address");
        }
        if (TextUtils.isEmpty(s1))
        {
            throw new drp("SmsSender: empty text message");
        }
        smsmanager = SmsManager.getDefault();
        if (dqv.a().k() != null && (add.c(s) || dqv.a().a(s)))
        {
        ...
        if (i1 <= 0)
        {
            throw new drp("SmsSender: fails to divide message");
        }
        ...
        if (d == null)
        {
            d = Boolean.valueOf(dqv.a().q());
        }
        flag = g.a(d, false);
        if (!g.a(g.nS, "babel_sms_use_samsung_galaxy_s2_hidden_api", false)) goto _L2; else goto _L1
_L1:
        if (a)
        {
            ebw.b("Babel_SMS", "SmsSender: Samsung phone. Try the fix");
        }
...
_L5:
        ...
        try
        {
            ebw.d("Babel_SMS", "SmsSender: failed Samsung Galaxy S2 SmsManager fix", context);
        }
        // Misplaced declaration of an exception variable
        catch (Context context)
        {
            throw new drp("SmsSender: caught exception in sending", context);
        }
          goto _L2
_L12:
...
_L11:
    ...
    public static drv a(Context context, String s, String s1, String s2, boolean flag, long l)
    {
        drv drv1;
        long l2;
        drv1 = new drv();
        ...
        if (a)
        {
            ...
            String s4 = String.valueOf(ebw.b(s));
            String s5 = String.valueOf(ebw.b(s1));
            ebw.b("Babel_SMS", (new StringBuilder(String.valueOf(s3).length() + 83 + String.valueOf(s4).length() + String.valueOf(s5).length() + String.valueOf(s2).length())).append(s3).append(s4).append(" message=").append(s5).append(" serviceCenter=").append(s2).append(" requireDeliveryReport=").append(flag).append(" requestId=").append(l2).toString());
        }
        drv1;
        JVM INSTR monitorenter ;
        long l1;
        long l3;
        b.put(Long.valueOf(l2), drv1);
        int j = a(context, s, s1, l2, s2, flag, l);
        if (a)
        {
            ebw.b("Babel_SMS", (new StringBuilder(32)).append("Sending SMS in ").append(j).append(" parts").toString());
        }
        drv1.a(j);
        l1 = g.a(g.nS, "babel_sms_send_timeout_in_millis", 0x493e0L);
...
_L1:
        if (a)
        {
            ebw.b("Babel_SMS", (new StringBuilder(28)).append("Waiting ").append(l).toString());
        }
        drv1.wait(l);
_L3:
        if (drv1.a())
        ...
        if (a)
        {
            ebw.b("Babel_SMS", (new StringBuilder(59)).append("No more pending messages after waiting ").append(l).toString());
        }
_L2:
        ...
        if (a)
        {
            ...
            s = String.valueOf(ebw.b(s));
            s1 = String.valueOf(ebw.b(s1));
            s2 = String.valueOf(drv1);
            ebw.b("Babel_SMS", (new StringBuilder(String.valueOf(context).length() + 17 + String.valueOf(s).length() + String.valueOf(s1).length() + String.valueOf(s2).length())).append(context).append(s).append(" message=").append(s1).append(" result=").append(s2).toString());
        }
        drv1;
        JVM INSTR monitorexit ;
        return drv1;
        context;
        ebw.g("Babel_SMS", "SmsSender: sending wait interrupted");
          goto _L3
        context;
        drv1;
        JVM INSTR monitorexit ;
...
_L1:
        ...
        ebw.g("Babel_SMS", (new StringBuilder(String.valueOf(s).length() + 43)).append(s).append(l).append(" resultCode=").append(j).toString());
_L7:
        if (l < 0L) goto _L4; else goto _L3
_L3:
        Object obj = (drv)b.get(Long.valueOf(l));
...
_L2:
        if (a)
        {
            ...
            ebw.b("Babel_SMS", (new StringBuilder(String.valueOf(obj).length() + 43)).append(((String) (obj))).append(l).append(" resultCode=").append(j).toString());
        }
