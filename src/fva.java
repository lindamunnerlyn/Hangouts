...
public abstract class fva extends Binder
    implements fuz
{
    ...
    public static fuz a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fuz))
        {
            return (fuz)iinterface;
        } else
        {
            return new fvb(ibinder);
        }
    }
