...
public final class goq
{
    ...
    private static final gpq l = (new gpq()).b("NA");
    ...
    private String a(char c1, boolean flag)
    {
        ...
        boolean flag1;
        if (Character.isDigit(c1) || d.length() == 1 && gpb.b.matcher(Character.toString(c1)).matches())
        {
            flag1 = true;
        } else
        {
...
_L7:
        if (i)
        {
            ...
            s1 = String.valueOf(String.valueOf(w));
            String s2 = String.valueOf(String.valueOf(z.toString()));
            return (new StringBuilder(s1.length() + 0 + s2.length())).append(s1).append(s2).toString();
        }
...
_L13:
    ...
    private void b(String s1)
    {
        ...
        do
        {
            ...
            gpo gpo1 = (gpo)iterator.next();
            if (gpo1.c() != 0)
            {
                int j1 = Math.min(i1 - 3, gpo1.c() - 1);
                if (!B.a(gpo1.a(j1)).matcher(s1).lookingAt())
                {
                    iterator.remove();
                }
            }
    ...
    private String c(String s1)
    {
        ...
        {
            String s2 = String.valueOf(String.valueOf(new String(w)));
            s1 = String.valueOf(String.valueOf(s1));
            return (new StringBuilder(s2.length() + 1 + s1.length())).append(s2).append(' ').append(s1).toString();
        } else
        {
            String s3 = String.valueOf(String.valueOf(w));
            s1 = String.valueOf(String.valueOf(s1));
            return (new StringBuilder(s3.length() + 0 + s1.length())).append(s3).append(s1).toString();
        }
    }
...
_L2:
    ...
    private String e()
    {
        ...
        {
            gpo gpo1 = (gpo)iterator.next();
            Matcher matcher = B.a(gpo1.a()).matcher(z);
            if (matcher.matches())
            {
                x = r.matcher(gpo1.d()).find();
                return c(matcher.replaceAll(gpo1.b()));
            }
        }
    ...
    private String f()
    {
        if (z.length() >= 3)
        {
            ...
            do
            {
                ...
                gpo gpo1 = (gpo)((Iterator) (obj)).next();
                if (!flag || h || gpo1.e() || gpb.c(gpo1.d()))
                {
                    String s2 = gpo1.b();
...
_L3:
    ...
    private boolean i()
    {
        ...
        obj = gpy1.a(((String) (obj))).matcher(e);
