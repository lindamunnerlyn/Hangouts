...
public abstract class fkv extends Binder
    implements fku
{

    public static fku a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fku))
        {
            return (fku)iinterface;
        } else
        {
            return new fkw(ibinder);
        }
    }
