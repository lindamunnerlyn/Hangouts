    ...
    implements android.os.Parcelable.Creator
{
    ...
    public static void a(PredictedNetworkQuality predictednetworkquality, Parcel parcel)
    {
        ...
        g.b(parcel, 1, predictednetworkquality.a);
        g.b(parcel, 2, predictednetworkquality.b);
        g.b(parcel, 3, predictednetworkquality.c);
        g.a(parcel, 4, predictednetworkquality.d);
        g.a(parcel, 5, predictednetworkquality.e);
        g.q(parcel, i);
    }
