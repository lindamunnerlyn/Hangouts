...
public abstract class bjo extends BaseAdapter
{
    ...
    public bjo(Resources resources, eaf eaf1)
    {
        b = resources;
        d = resources.getResourcePackageName(g.cq);
        a = eaf1;
        int i = resources.getDimensionPixelSize(g.eh) + resources.getDimensionPixelSize(g.eg) * 2;
...
_L3:
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        if (view == null)
        {
            ...
            int j = b.getDimensionPixelSize(g.eg);
        ...
        {
            viewgroup = (new StringBuffer()).appendCodePoint(l).toString();
        } else
        {
            ...
            viewgroup = viewgroup.getString(i);
        }
