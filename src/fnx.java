...
public final class fnx
{
    ...
    private static long a(Context context, String s, String s1, String as[])
    {
        ...
        s1 = fqa.c(s1);
        context = context.getContentResolver().query(android.provider.ContactsContract.RawContacts.CONTENT_URI, as, "account_name=?1 AND account_type='com.google' AND sourceid=?2 AND data_set IS 'plus'", fqa.b(s, s1), null);
        if (context == null)
        {
            g.m(5);
            return -1L;
