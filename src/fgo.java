...
public abstract class fgo extends Binder
    implements fgn
{

    public static fgn a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fgn))
        {
            return (fgn)iinterface;
        } else
        {
            return new fgp(ibinder);
        }
    }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 2: // '\002'
            ...
            a(ezy1, ((GoogleMapOptions) (obj)), parcel);
            parcel1.writeNoException();
            return true;
