...
public final class gyr
{
    ...
    public gyr(Context context, String s, long l, long l1, float f1, 
            float f2)
    {
        Object obj;
        ...
        this(context, s, l, l1, f1, f2, ((gyt) (obj)));
    }

    private gyr(Context context, String s, long l, long l1, float f1, 
            float f2, gyt gyt1)
    {
        a = context;
        b = s;
    ...
    public void a(String s, ByteBuffer bytebuffer)
    {
        String s1 = b(s);
        try
        {
