    ...
    implements MenuItem
{
    ...
    public te(Context context, fs fs1)
    {
        super(context, fs1);
    }

    tf a(ActionProvider actionprovider)
    {
        return new tf(this, a, actionprovider);
    }
    ...
    public MenuItem setActionView(int i)
    {
        ...
        {
            ((fs)d).setActionView(new tg(view));
        }
        return this;
    }
    ...
    public MenuItem setOnActionExpandListener(android.view.MenuItem.OnActionExpandListener onactionexpandlistener)
    {
        ...
        {
            onactionexpandlistener = new th(this, onactionexpandlistener);
        } else
        {
    ...
    public MenuItem setOnMenuItemClickListener(android.view.MenuItem.OnMenuItemClickListener onmenuitemclicklistener)
    {
        ...
        {
            onmenuitemclicklistener = new ti(this, onmenuitemclicklistener);
        } else
        {
