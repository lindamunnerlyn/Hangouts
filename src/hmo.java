...
public final class hmo extends hmp
{
    ...
    private hmo(byte byte0)
    {
        this(0, a);
    }

    private hmo(int i1, byte abyte0[])
    {
        this(0, abyte0, false);
    }

    private hmo(int i1, byte abyte0[], boolean flag)
    {
        int j1;
        if (abyte0 == null)
        {
    ...
    private static byte[] a(byte abyte0[], boolean flag, boolean flag1)
    {
        ...
        hmo hmo1 = new hmo(0, a, flag1);
        long l1 = hmo1.e(abyte0);
        if (l1 > 0x7fffffffL)
        {
