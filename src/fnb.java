...
public class fnb
{
    ...
    public fnb(Context context, ejx ejx1, boolean flag)
    {
        b = context;
        c = ejx1;
        h = flag;
        ejx1 = context.getResources();
        j = ejx1.getInteger(g.rB);
        i = ejx1.getInteger(g.rA);
...
_L1:
    ...
    static boolean a(fnb fnb1)
    {
        return fnb1.h;
    }

    static float b(fnb fnb1)
    {
        return fnb1.i;
    }

    static float c(fnb fnb1)
    {
        return fnb1.j;
    }

    static ConcurrentHashMap d(fnb fnb1)
    {
        return fnb1.d;
    }
    ...
    public void a(Status status, ParcelFileDescriptor parcelfiledescriptor, int l, int i1, int j1, fnc fnc1)
    {
        fnc fnc2 = f;
        if (fnc2 == fnc1) goto _L2; else goto _L1
_L1:
        if (!e)
        {
            a();
...
_L6:
        status = new fnd(this, fnc1, parcelfiledescriptor, l, i1, j1);
...
_L7:
    ...
    public void a(Status status, ParcelFileDescriptor parcelfiledescriptor, fnc fnc1, int l)
    {
        a(status, parcelfiledescriptor, -1, -1, 0, fnc1);
    }

    public void a(fnc fnc1)
    {
        if (d.containsKey(fnc1.g))
        {
            fnc1.f.setImageBitmap((Bitmap)d.get(fnc1.g));
            a(fnc1.f);
        } else
        {
            ImageView imageview = fnc1.f;
            a(imageview);
            if (c.e())
            {
                imageview.setTag(fnc1);
                g.add(fnc1);
                a();
                return;
            }
