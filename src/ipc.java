...
public final class ipc extends koj
{

    public static final kok a = kok.a(ipc, 0x102d7e72L);
    private static final ipc p[] = new ipc[0];
    public String b;
    public ipf c[];
    public String d[];
    public String e;
...
_L7:
        ...
        if (k1 != 0)
        {
            System.arraycopy(c, 0, aipf, 0, k1);
            j2 = k1;
        }
        for (; j2 < aipf.length - 1; j2++)
        {
            aipf[j2] = new ipf();
            kog1.a(aipf[j2]);
            kog1.a();
