...
public interface cey
{
    ...
    public static final String c = (new StringBuilder(String.valueOf(s).length() + 87 + String.valueOf(s1).length() + String.valueOf(s2).length() + String.valueOf(s3).length() + String.valueOf(s4).length() + String.valueOf(s5).length() + String.valueOf(s6).length())).append(s).append(i).append(" AND ").append(s1).append("!=").append(j).append(" AND ").append(s2).append("!=1 AND ").append(s3).append("!=1 AND ").append(s4).append("<0) OR (").append(s5).append(" AND ").append(s6).append(">=0)").toString();
    ...
    
    {
        ...
        s3 = String.valueOf("observed_status");
