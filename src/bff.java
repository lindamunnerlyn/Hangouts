    ...
    implements android.content.DialogInterface.OnClickListener
{
    ...
    public static bff a(String s, String s1, String s2, String s3)
    {
    ...
    {
        super.onStart();
        TextView textview = (TextView)c().findViewById(0x102000b);
        textview.setLinkTextColor(getResources().getColor(g.db));
