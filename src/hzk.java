...
public final class hzk extends koj
{
...
_L13:
        ...
        if (l1 != 0)
        {
            System.arraycopy(p, 0, ahzt, 0, l1);
            i5 = l1;
        }
        for (; i5 < ahzt.length - 1; i5++)
        {
            ahzt[i5] = new hzt();
            kog1.a(ahzt[i5]);
            kog1.a();
...
_L14:
        ...
        if (i2 != 0)
        {
            System.arraycopy(o, 0, aigr, 0, i2);
            j5 = i2;
        }
        for (; j5 < aigr.length - 1; j5++)
        {
            aigr[j5] = new igr();
            kog1.a(aigr[j5]);
            kog1.a();
...
_L22:
        ...
        if (j3 != 0)
        {
            System.arraycopy(w, 0, aifi, 0, j3);
            i6 = j3;
        }
        for (; i6 < aifi.length - 1; i6++)
        {
            aifi[i6] = new ifi();
            kog1.a(aifi[i6]);
            kog1.a();
...
_L32:
        ...
        if (k3 != 0)
        {
            System.arraycopy(I, 0, akpx, 0, k3);
            j6 = k3;
        }
        for (; j6 < akpx.length - 1; j6++)
        {
            akpx[j6] = new kpx();
            kog1.a(akpx[j6]);
            kog1.a();
...
_L38:
        ...
        if (i4 != 0)
        {
            System.arraycopy(J, 0, ahyc, 0, i4);
            l6 = i4;
        }
        for (; l6 < ahyc.length - 1; l6++)
        {
            ahyc[l6] = new hyc();
            kog1.a(ahyc[l6]);
            kog1.a();
...
_L40:
        ...
        if (j4 != 0)
        {
            System.arraycopy(O, 0, ahzl, 0, j4);
            i7 = j4;
        }
        for (; i7 < ahzl.length - 1; i7++)
        {
            ahzl[i7] = new hzl();
            kog1.a(ahzl[i7]);
            kog1.a();
...
_L41:
        ...
        if (k4 != 0)
        {
            System.arraycopy(P, 0, ahxz, 0, k4);
            j7 = k4;
        }
        for (; j7 < ahxz.length - 1; j7++)
        {
            ahxz[j7] = new hxz();
            kog1.a(ahxz[j7]);
            kog1.a();
