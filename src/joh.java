...
public final class joh extends ReentrantLock
{
    ...
    public joh(MapMakerInternalMap mapmakerinternalmap, int i1, int j1)
    {
        Object obj1 = null;
        super();
    ...
    private com.google.common.collect.MapMakerInternalMap.ReferenceEntry a(com.google.common.collect.MapMakerInternalMap.ReferenceEntry referenceentry, com.google.common.collect.MapMakerInternalMap.ReferenceEntry referenceentry1)
    {
        ...
        {
            jou jou1 = referenceentry.getValueReference();
            Object obj = jou1.get();
            if (obj != null)
            {
                referenceentry = a.n.a(this, referenceentry, referenceentry1);
                referenceentry.setValueReference(jou1.a(h, obj, referenceentry));
    ...
    private void a(com.google.common.collect.MapMakerInternalMap.ReferenceEntry referenceentry, jnb jnb1)
    {
        Object obj = referenceentry.getKey();
        referenceentry.getHash();
        a(obj, referenceentry.getValueReference().get(), jnb1);
    }

    private void a(Object obj, Object obj1, jnb jnb1)
    {
        if (a.l != MapMakerInternalMap.q)
        {
            obj = new jnh(obj, obj1, jnb1);
            a.l.offer(obj);
        }
    }

    private boolean a(com.google.common.collect.MapMakerInternalMap.ReferenceEntry referenceentry, int i1, jnb jnb1)
    {
        int j1 = b;
        ...
        for (com.google.common.collect.MapMakerInternalMap.ReferenceEntry referenceentry1 = referenceentry2; referenceentry1 != null; referenceentry1 = referenceentry1.getNext())
        {
            ...
            {
                c = c + 1;
                a(referenceentry1.getKey(), referenceentry1.getValueReference().get(), jnb1);
    ...
    private static boolean a(jou jou1)
    {
        return jou1.get() == null;
    }
...
_L2:
        ...
        do
        {
            ...
            if (!a(referenceentry, referenceentry.getHash(), jnb.d))
            {
...
_L2:
        ...
        jou1 = referenceentry.getValueReference();
        obj3 = jou1.get();
        if (obj3 != null)
        {
...
_L17:
        ...
        if (!a(((com.google.common.collect.MapMakerInternalMap.ReferenceEntry) (obj)), ((com.google.common.collect.MapMakerInternalMap.ReferenceEntry) (obj)).getHash(), jnb.e))
        {
            throw new AssertionError();
        }
          goto _L19
...
_L2:
        ...
        c = c + 1;
        a(referenceentry1.getKey(), referenceentry1.getValueReference().get(), jnb.c);
        referenceentry = b(referenceentry2, referenceentry1);
        int k1 = b;
        atomicreferencearray.set(i1, referenceentry);
        b = k1 - 1;
...
_L1:
    ...
    public boolean a(Object obj, int i1, jou jou1)
    {
        lock();
        com.google.common.collect.MapMakerInternalMap.ReferenceEntry referenceentry1;
        AtomicReferenceArray atomicreferencearray;
...
_L2:
        ...
        if (referenceentry.getValueReference() != jou1)
        {
            break MISSING_BLOCK_LABEL_170;
        }
        c = c + 1;
        a(obj, jou1.get(), jnb.c);
        obj = b(referenceentry1, referenceentry);
        i1 = b;
        atomicreferencearray.set(j1, obj);
        b = i1 - 1;
