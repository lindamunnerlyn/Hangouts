    ...
    implements android.os.Parcelable.Creator
{
    ...
    public static void a(PlaceImpl placeimpl, Parcel parcel, int i)
    {
        ...
        g.a(parcel, 1, placeimpl.a());
        g.a(parcel, 2, placeimpl.t());
        g.a(parcel, 3, placeimpl.v(), i);
        g.a(parcel, 4, placeimpl.d(), i);
        g.a(parcel, 5, placeimpl.j());
        g.a(parcel, 6, placeimpl.k(), i);
        g.a(parcel, 7, placeimpl.u());
        g.a(parcel, 8, placeimpl.l(), i);
        g.a(parcel, 9, placeimpl.p());
        g.a(parcel, 10, placeimpl.q());
        g.b(parcel, 11, placeimpl.r());
        g.a(parcel, 12, placeimpl.s());
        g.a(parcel, 13, placeimpl.g());
        g.a(parcel, 14, placeimpl.i());
        g.a(parcel, 15, placeimpl.m());
        g.b(parcel, 17, placeimpl.o());
        g.a(parcel, 16, placeimpl.n());
        g.b(parcel, 1000, placeimpl.a);
        g.a(parcel, 19, placeimpl.h());
        g.a(parcel, 18, placeimpl.b);
        g.a(parcel, 20, placeimpl.f());
        g.q(parcel, j);
    }
