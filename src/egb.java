...
public final class egb
{
    ...
    private final Runnable o = new egc(this);

    public egb(AudioAttachmentView audioattachmentview, String s, String s1, long l1)
    {
    ...
    private static void a(egb egb1)
    {
        if (a != egb1)
        {
            a = egb1;
...
_L6:
    ...
    public void a(egf egf1)
    {
        a("preloadAudioDataSourceIfNecessary", "");
        if (b() == 0 && egf1 != null && !b(d, i))
        {
            b(1);
            egf1.a();
        }
...
_L3:
    ...
    public void a(String s, String s1)
    {
        if (AudioAttachmentView.g())
        {
            String s2 = f;
            String s3 = g;
            String s4 = String.valueOf(c(e));
            eev.b("Babel", (new StringBuilder(String.valueOf(s).length() + 27 + String.valueOf(s2).length() + String.valueOf(s3).length() + String.valueOf(s4).length() + String.valueOf(s1).length())).append(s).append(" messageId:").append(s2).append(" playId:").append(s3).append(" state:").append(s4).append(" ").append(s1).toString());
        }
    }
    ...
    public void d()
    {
        if (j.isWiredHeadsetOn())
        {
            eev.f("Babel", "toggleAudioOutput: isWiredHeadset is true.");
        } else
        {
            if ("speaker".equals(c()))
            {
    ...
    public void k()
    {
        ...
        case 0: // '\0'
            ...
            {
                eev.f("Babel", "No audioUrl, and no audioUrlFetcher.");
                b(0);
                return;
            }
