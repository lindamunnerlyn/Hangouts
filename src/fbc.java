...
public abstract class fbc extends Binder
    implements fbb
{
    ...
    public static fbb a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fbb))
        {
            return (fbb)iinterface;
        } else
        {
            return new fbd(ibinder);
        }
    }
