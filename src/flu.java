    ...
    implements android.os.Parcelable.Creator
{
    ...
    public static void a(StreetViewPanoramaOptions streetviewpanoramaoptions, Parcel parcel, int i)
    {
        ...
        g.b(parcel, 1, streetviewpanoramaoptions.a());
        g.a(parcel, 2, streetviewpanoramaoptions.g(), i);
        g.a(parcel, 3, streetviewpanoramaoptions.j());
        g.a(parcel, 4, streetviewpanoramaoptions.h(), i);
        Integer integer = streetviewpanoramaoptions.i();
        if (integer != null)
        {
            g.a(parcel, 5, 4);
            parcel.writeInt(integer.intValue());
        }
        g.a(parcel, 6, streetviewpanoramaoptions.b());
        g.a(parcel, 7, streetviewpanoramaoptions.c());
        g.a(parcel, 8, streetviewpanoramaoptions.d());
        g.a(parcel, 9, streetviewpanoramaoptions.e());
        g.a(parcel, 10, streetviewpanoramaoptions.f());
        g.q(parcel, j);
    }
