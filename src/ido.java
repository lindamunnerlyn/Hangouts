...
public final class ido extends kwm
{
    ...
    public kws mergeFrom(kwj kwj1)
    {
        do
        {
            ...
            case 18: // '\022'
                int k3 = kwj1.c(kwj1.p());
                int i1 = kwj1.r();
                int k2;
                for (k2 = 0; kwj1.q() > 0; k2++)
                {
                    kwj1.f();
                }
