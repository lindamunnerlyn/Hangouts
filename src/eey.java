...
public final class eey
{
    ...
    private static final efa b = new efa();
    ...
    private static final gqb i = gqb.a();
    private static final gpb j = gpb.b();
    ...
    private static eex a(String s, String s1, boolean flag)
    {
        eex eex1;
label0:
        {
            if (s == null)
            {
                throw new gov(gow.b, "Number may not be null");
            }
            eex eex2 = (eex)b.a(s);
            if (eex2 != null && eex2.a(s1))
            {
                eex1 = eex2;
                if (eex2.a() == flag)
                {
    ...
    public static String a(String s, int i1)
    {
        ...
        {
            return g.nU.getResources().getString(g.qM);
        } else
        {
...
_L1:
        if (!((cjf)hlp.a(context, cjf)).a("android.permission.ACCESS_COARSE_LOCATION")) goto _L4; else goto _L3
_L3:
...
label0:
        ...
        if (a)
        {
            eev.b("Babel", "unable to determine user's phone country code");
        }
...
_L6:
    ...
    public static String b(String s, String s1)
    {
        ...
        if (!s1.equals(Locale.US.getCountry()) || !i.a(eex1.c(), s1)) goto _L2; else goto _L1
_L1:
        Iterator iterator;
        s1 = eex1.a(gpl.a);
        iterator = m.iterator();
...
_L2:
    ...
    public static boolean c()
    {
        ...
        if (a)
        {
            eev.b("Babel", (new StringBuilder(50)).append("telephonyManager.getSimState() returns:").append(i1).toString());
        }
        return i1 != 1;
    }
    ...
    public static boolean e(String s, String s1)
    {
        ...
        eex eex1;
        eex1 = a(s, s2, false);
        s1 = eex1.a(a(s1, s2, false));
        if (i.a(eex1.c(), s2)) goto _L2; else goto _L1
_L1:
        if (!s2.equals("US"))
        {
...
_L4:
        ...
        if (!((eex) (obj)).d()) goto _L8; else goto _L7
_L7:
        s = String.valueOf(s);
        s1 = String.valueOf(((eex) (obj)).a(gpl.a));
        if (s1.length() != 0)
        {
            return s.concat(s1);
        }
...
_L8:
        if (!i.a(((eex) (obj)).c(), s1)) goto _L10; else goto _L9
_L9:
        s = String.valueOf(s);
        s1 = String.valueOf(((eex) (obj)).a(gpl.c));
        if (s1.length() != 0)
        {
            return s.concat(s1);
        }
    ...
    {
        cjf cjf1 = (cjf)hlp.a(g.nU, cjf);
        return cjf1.a("android.permission.READ_PHONE_STATE") || cjf1.a("android.permission.READ_SMS");
    }
    ...
    public static String j()
    {
        ...
        if (a)
        {
            eev.b("Babel", "unable to determine user's phone region code");
        }
        return "US";
    }
    ...
    {
        return (TelephonyManager)g.nU.getSystemService("phone");
    }
...
_L1:
        Object obj = g.nU.getResources().getString(g.qM);
_L4:
        return ((String) (obj));
_L2:
        if (s == null)
...
_L3:
        eex eex1 = a(l(s), null, c(s));
        if (!eex1.b()) goto _L6; else goto _L5
_L5:
        int i1 = gpl.c;
_L13:
        String s1 = a(eex1.a(i1), efb.a);
        obj = s1;
        if (!eex1.a()) goto _L8; else goto _L7
_L7:
...
_L6:
        ...
        {
            obj = String.valueOf(((gov) (obj)).getMessage());
            eev.a("Babel", (new StringBuilder(String.valueOf(s).length() + 35 + String.valueOf(obj).length())).append("Failed to parse '").append(s).append("' into PhoneInfo: ").append(((String) (obj))).toString());
            return a(s, efb.a);
        }
        continue; /* Loop/switch isn't completed */
_L10:
