    ...
    implements amj
{
    ...
    public bzy(String s, Cursor cursor)
    {
        a = s;
        b = cursor;
    }
    ...
    public amf a()
    {
        ...
        if (!TextUtils.isEmpty(s))
        {
            ...
            while (i < j) 
            {
                ...
                if (k == 0)
                {
                    boolean flag = ebr.d(Integer.parseInt(obj1[4]));
                    obj1 = new aml(obj1[3], obj1[1], obj1[2], obj1[10], flag);
                    arraylist.add(obj1);
                    if (obj != null)
                    {
                        ((ame) (obj)).a(((aml) (obj1)));
        ...
        obj = (new ami()).b(getString(5)).b(ebr.d(getInt(8))).a(ebr.d(getInt(9))).a().c(ebr.d(getInt(6))).a(getString(4)).a(gz1.values()).c(arraylist).b(arraylist1);
        if (!isNull(1))
        {
            ((ami) (obj)).c(String.valueOf(getString(1)));
        }
        if (!isNull(2))
        {
            ((ami) (obj)).d(String.valueOf(getLong(2)));
        }
        return ((ami) (obj)).b();
    }
