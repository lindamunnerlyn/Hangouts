...
public final class hgk extends ac
{
    ...
    public static hgk a(String s, String s1, ad ad)
    {
    ...
    private void q()
    {
        if (ak == null)
        {
            ...
            hashmap.put("LEFT 1", aj.findViewById(l.uJ));
            hashmap.put("CENTER 1", aj.findViewById(l.uK));
            hashmap.put("RIGHT 1", aj.findViewById(l.uL));
            if (gqb.a == null)
            {
                gqb.a = new gqb();
            }
            ak = gqb.a.a(getActivity(), g.tu, hashmap);
            ak.addListener(new hgl(this));
        }
        if (ak.isStarted())
        {
            ak.cancel();
    ...
    public void onCancel(DialogInterface dialoginterface)
    {
        ...
        if (getTargetFragment() instanceof hgm)
        {
            getArguments();
        }
    }
