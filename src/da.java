    ...
    implements by, bz
{
    ...
    public da(Context context, Notification notification, CharSequence charsequence, CharSequence charsequence1, CharSequence charsequence2, RemoteViews remoteviews, int i, 
    ...
    {
        android.util.SparseArray sparsearray = cy.a(c);
        if (sparsearray != null)
        {
