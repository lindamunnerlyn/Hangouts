...
public final class ipd extends koj
{
...
_L61:
        ...
        i6 = kog1.f();
        i6;
        JVM INSTR tableswitch 0 54: default 2280
    //                   0 2289
    //                   1 2289
    //                   2 2289
    //                   3 2289
...
_L50:
        ...
        if (j1 != 0)
        {
            System.arraycopy(S, 0, aioz, 0, j1);
            i4 = j1;
        }
        for (; i4 < aioz.length - 1; i4++)
        {
            aioz[i4] = new ioz();
            kog1.a(aioz[i4]);
            kog1.a();
...
_L55:
        ...
        if (l1 != 0)
        {
            System.arraycopy(Z, 0, aipl, 0, l1);
            k4 = l1;
        }
        for (; k4 < aipl.length - 1; k4++)
        {
            aipl[k4] = new ipl();
            kog1.a(aipl[k4]);
            kog1.a();
