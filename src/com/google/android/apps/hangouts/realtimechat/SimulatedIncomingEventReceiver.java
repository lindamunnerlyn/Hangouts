...
public class SimulatedIncomingEventReceiver extends BroadcastReceiver
{
    ...
    public void onReceive(Context context, Intent intent)
    {
        ...
        if (intent.getAction().equals("com.google.android.babel.intent.SIMULATED_MESSAGE_EVENT"))
        {
            ...
            a(context);
            cey1 = cey.a(intent.getStringExtra("sender_id"));
            context = String.valueOf(cey1);
            ...
            a(context);
            context = cey.a(intent.getStringExtra("recipient_id"));
            ...
            context = dbf.a(context);
            intent = new ArrayList();
            arraylist = new ArrayList();
            arraylist.add(new crr(0, s5, 0, null));
            intent.add(crm.a(s1, arraylist, cey1, l, s7));
        ...
        } else
        {
            if (intent.getAction().equals("com.google.android.babel.intent.SIMULATED_FOCUS_EVENT"))
            {
                ...
                intent = cey.a(intent.getStringExtra("recipient_id"));
                ...
                intent = dbf.a(intent);
                obj4 = new ArrayList();
                ((List) (obj4)).add(czk.a(s2, i, context, l1));
                ((List) (obj4)).add(czk.a(s2, i, ((cey) (obj)), l1));
                ((List) (obj4)).add(czk.a(s2, i, ((cey) (obj3)), l1));
            ...
            if (intent.getAction().equals("com.google.android.babel.intent.SIMULATED_WATERMARK_EVENT"))
            {
                ...
                intent = dbf.a(intent);
                obj1 = new ArrayList();
                ((List) (obj1)).add(czn.a(s3, context, l2));
            ...
            if (intent.getAction().equals("com.google.android.babel.intent.SIMULATED_TYPING_EVENT"))
            {
                ...
                obj2 = cey.a(intent.getStringExtra("recipient_id"));
                ...
                intent = dbf.a(((cey) (obj2)));
                obj2 = new ArrayList();
                ((List) (obj2)).add(czl.a(s4, context, l3, j));
