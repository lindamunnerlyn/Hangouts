...
public abstract class fbf extends Binder
    implements fbe
{

    public static fbe a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fbe))
        {
            return (fbe)iinterface;
        } else
        {
            return new fbg(ibinder);
        }
    }
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 1: // '\001'
            ...
            a(googlehelp, fbc.a(parcel.readStrongBinder()));
        ...
        case 2: // '\002'
            ...
            a(googlehelp1, bitmap1, fbc.a(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        ...
        case 3: // '\003'
            ...
            a(bitmap, fbc.a(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 4: // '\004'
            parcel.enforceInterface("com.google.android.gms.googlehelp.internal.common.IGoogleHelpService");
            a(fbc.a(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 5: // '\005'
            parcel.enforceInterface("com.google.android.gms.googlehelp.internal.common.IGoogleHelpService");
            b(fbc.a(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 6: // '\006'
            parcel.enforceInterface("com.google.android.gms.googlehelp.internal.common.IGoogleHelpService");
            c(fbc.a(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        }
    }
