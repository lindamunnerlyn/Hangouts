    ...
    implements gwz
{
    ...
    private static final gxf a = new gxf();
    ...
    private static void b(SQLiteDatabase sqlitedatabase, gwz gwz1)
    {
        java.util.List list = Arrays.asList(b(sqlitedatabase, gwz1.a()));
        Object obj = Arrays.asList(gwz1.b());
        ...
        ((ContentValues) (obj1)).put("partition_name", gwz1.a());
        for (gwz1 = ((Set) (obj)).iterator(); gwz1.hasNext(); sqlitedatabase.insert("partition_tables", null, ((ContentValues) (obj1))))
        {
            ((ContentValues) (obj1)).put("table_name", (String)gwz1.next());
        }
...
_L1:
    ...
    private static void c(SQLiteDatabase sqlitedatabase, gwz gwz1)
    {
        java.util.List list = Arrays.asList(c(sqlitedatabase, gwz1.a()));
        Object obj = Arrays.asList(gwz1.c());
        Object obj1 = new HashSet(list);
        ((Set) (obj1)).removeAll(((java.util.Collection) (obj)));
        obj = new HashSet(((java.util.Collection) (obj)));
        ((Set) (obj)).removeAll(list);
        ...
        obj1 = new ContentValues(2);
        ((ContentValues) (obj1)).put("partition_name", gwz1.a());
        for (gwz1 = ((Set) (obj)).iterator(); gwz1.hasNext(); sqlitedatabase.insert("partition_views", null, ((ContentValues) (obj1))))
        {
            ((ContentValues) (obj1)).put("view_name", (String)gwz1.next());
        }
...
_L1:
    ...
    void a(SQLiteDatabase sqlitedatabase, gwz gwz1)
    {
        ContentValues contentvalues = new ContentValues(2);
        contentvalues.put("partition_name", gwz1.a());
        contentvalues.put("version", Integer.valueOf(1));
        sqlitedatabase.replace("partition_versions", null, contentvalues);
        b(sqlitedatabase, gwz1);
        c(sqlitedatabase, gwz1);
    }
