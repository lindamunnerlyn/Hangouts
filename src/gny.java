...
final class gny
{
    ...
    private void a(String s, Map map, String s1, String s2)
    {
        ...
        hii1.println((new StringBuilder(String.valueOf(s).length() + 3 + String.valueOf(s2).length() + String.valueOf(map).length())).append(s).append(s2).append(" = ").append(map).toString());
    }
    ...
    private void a(Map map)
    {
        ...
        while (((Iterator) (obj)).hasNext()) 
        {
            ...
            } else
            {
                ...
                {
                    Object obj1 = a.a(i);
                    map = String.valueOf(((gmu) (obj1)).b("account_name"));
                    obj1 = String.valueOf(((gmu) (obj1)).b("effective_gaia_id"));
