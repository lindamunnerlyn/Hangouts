...
public abstract class fhg extends Binder
    implements fhf
{

    public static fhf a(IBinder ibinder)
    {
        if (ibinder == null)
        {
            return null;
        ...
        if (iinterface != null && (iinterface instanceof fhf))
        {
            return (fhf)iinterface;
        } else
        {
            return new fhh(ibinder);
        }
    }
